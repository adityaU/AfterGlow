const AGDraculaTheme = {
  ...
  colors: {
    ...
    'editorHoverWidget.border': 'var(--color-primary)',
    'quickInput.background': '#282a36',
    'quickInput.foreground': '#fff',
    'quickInput.list.focusBackground': 'var(--color-primary)',
    'quickInputTitle.background': 'var(--color-primary)',
    'editorWidget.foreground': '#fff',
    'editorWidget.background': '#282a36',
    'menu.background': '#282a36',
    'editorLink.activeForeground': 'var(--color-primary)',
    'textLink.foreground': 'var(--color-primary)',
