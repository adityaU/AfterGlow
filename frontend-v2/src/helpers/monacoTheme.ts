const AGDraculaTheme = {
  ...
  colors: {
    ...
    'editorHoverWidget.border': '#6574cd',
    'quickInput.background': '#282a36',
    'quickInput.foreground': '#fff',
    'quickInput.list.focusBackground': '#6574cd',
    'quickInputTitle.background': '#6574cd',
    'editorWidget.foreground': '#fff',
    'editorWidget.background': '#282a36',
    'menu.background': '#282a36',
    'editorLink.activeForeground': '#6574cd',
    'textLink.foreground': '#6574cd',
