      ...
      >
        ...
        <template #header>
          <div class="tw-w-full tw-flex tw-border-b tw-p-2">
            <div
              class="tw-flex tw-flex-wrap tw-gap-1 tw-w-full tw-justify-between"
            >
              ...
              <div class="tw-text-center">
                <AGColorSelector
                  ...
                  @selectColor="
                    (val) => editor.chain().focus().setColor(val).run()
                  "
                  naked="true"
          ...
          <div class="tw-grid tw-grid-cols-12">
            <div class="tw-col-start-11 tw-col-span-2 tw-p-2 tw-text-right">
              ...
              <AGButton
                ...
                "
                class="tw-bg-primary tw-text-white tw-py-0 tw-mr-2"
              >
                Save
              </AGButton>
            </div>
