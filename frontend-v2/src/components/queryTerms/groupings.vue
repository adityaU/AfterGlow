<template>
  <floating-menu :items="groupingsLocal" label="Group By" @clicked="(val) => newgrouping.showMenu = true">
    ...
    <template #menuSlot>
      <GroupingMenu @addgrouping="addgrouping" @editgrouping="(val) => newgrouping = val" addLabel="Add Group by" :reset="reset"
        :grouping="newGrouping" :columns="columns" :colDetails="colDetails" />
    </template>
  </floating-menu>
