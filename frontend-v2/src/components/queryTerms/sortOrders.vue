<template>
  <floating-menu :items="sortingsLocal" label="Sort Order" @clicked="(val) => newsorting.showMenu = true">
    ...
    <template #menuSlot>
      <SortingMenu @addsorting="addsorting" @editsorting="(val) => newsorting = val" addLabel="Add Sort Order" :reset="reset"
        :sorting="newsorting" :columns="columns" :colDetails="colDetails" />
    </template>
  </floating-menu>
