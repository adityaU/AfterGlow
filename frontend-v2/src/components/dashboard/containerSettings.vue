<template>
  <div>
    <div class="tw-flex tw-items-center tw-mb-2 tw-border-b tw-p-2 tw-pl-4">
      ...
      <div
        class="tw-text-right tw-flex-1 tw-font-semibold tw-text-primary tw-text-sm"
      >
        <span class="tw-cursor-pointer" @click="$emit('hide')">hide</span>
      </div>
    </div>
    <div class="tw-pl-4 tw-p-2 tw-rounded-b-2xl">
      <div class="tw-flex tw-items-center tw-mb-2 item-3070-columns">
        <div class="label">Shadow:</div>
        <BoxSelect
          class="tw-px-0"
          v-model:selected="formattingSettingsLocal.shadow"
      ...
      <div class="tw-flex tw-items-center tw-mb-2 item-3070-columns">
        ...
        <AGColorSelector
          naked="true"
          v-model:selectedColor="formattingSettingsLocal.backgroundColor"
        />
      </div>
      ...
      <div class="tw-flex tw-items-center tw-mb-2 item-3070-columns">
        ...
        <BoxSelect
          class="tw-px-0"
          v-model:selected="formattingSettingsLocal.borderPosition"
      ...
      <div class="tw-flex tw-items-center tw-mb-2 item-3070-columns">
        ...
        <AGColorSelector
          naked="true"
          v-model:selectedColor="formattingSettingsLocal.borderColor"
        />
      </div>
      ...
      <div class="tw-flex tw-items-center tw-mb-2 item-3070-columns">
        ...
        <q-slider
          class="tw-px-1"
          v-model="formattingSettingsLocal.borderThickness"
          step="1"
          :min="0"
          :max="10"
          color="primary"
      ...
      <div class="tw-flex tw-items-center tw-mb-2 item-3070-columns">
        ...
        <q-slider
          class="tw-px-1"
          v-model="formattingSettingsLocal.borderRadius"
          step="0.125"
          :min="0"
          :max="4"
          color="primary"
      ...
      <div class="tw-flex tw-items-center tw-mb-2 item-3070-columns">
        <div class="label">Gap around container:</div>
        <q-slider
          class="tw-px-1"
          v-model="formattingSettingsLocal.gapAround"
          step="0.125"
          :min="0"
          :max="10"
          color="primary"
      ...
      <div class="tw-flex tw-items-center tw-mb-2 item-3070-columns">
        <div class="label">Show Header:</div>
        ...
        <div class="tw-flex tw-items-center tw-mb-2 item-3070-columns">
          ...
          <AGColorSelector
            ...
            v-model:selectedColor="
              formattingSettingsLocal.headerBackgroundColor
            "
          />
        </div>
        <div class="tw-flex tw-items-center tw-mb-2 item-3070-columns">
          ...
          <AGColorSelector
            naked="true"
            v-model:selectedColor="formattingSettingsLocal.headerTextColor"
          />
        </div>
      </template>
    </div>
...
export default {
  ...
  data() {
    return {
      formattingSettingsLocal: this.formattingSettings
        ? {
            ...cloneDeep(newDashboardContainerSettings),
            ...cloneDeep(this.formattingSettings),
          }
        : cloneDeep(newDashboardContainerSettings),
