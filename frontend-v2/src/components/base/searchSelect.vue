...
<template>
  <div class="">
    ...
    <div class="input-border group !tw-py-2 !tw-px-2" @click="focusOnInput">
      <div class="tw-px-2 tw-py-0.5">
        ...
        <div class="tw-flex tw-justify-between tw-items-center">
          ...
          >
            ...
            >
              <span
                class="tw-rounded-l-sm tw-text-white tw-py-0.5 tw-px-2"
                :class="validate(value) ? 'tw-bg-primary' : 'tw-bg-red-700'"
              >
                {{ value }}
              </span>
              <span
                class="tw-rounded-r-sm tw-text-white tw-p-0.5 tw-cursor-pointer tw-flex tw-px-2"
                :class="
                  validate(value) ? 'tw-bg-primary/80' : 'tw-bg-red-700/80'
                "
              >
                <XIcon
                  size="14"
