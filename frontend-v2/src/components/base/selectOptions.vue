        ...
        <div class="" @keydown="onKeydown" tabindex="0">
                ...
                <div class="card tw-grid tw-grid-cols-1 tw-divider-y">
                        <a href="#" @click="select(el)" :tabindex="index + 1"
                                class="tw-group tw-py-1 tw-px-2 tw-block tw-w-full hover:tw-bg-primary hover:!tw-text-white tw-text-ellipsis focus:tw-bg-primary focus:tw-text-white tw-border-b last:tw-border-b-0"
                                ...
                                <span class="tw-grid tw-grid-cols-12" v-if="areOptionObjects">
                                        <span class="tw-col-span-6">{{ el.name }}</span>
                                ...
                                <span class="" v-if="!areOptionObjects">
                                        <span>{{ el }}</span>
                                </span>
...
export default {
        ...
        props: ['options', 'selected', 'menuShow', 'includeQuery', 'multiselect', 'iconLetter', 'hideSearch', 'areOptionObjects'],
