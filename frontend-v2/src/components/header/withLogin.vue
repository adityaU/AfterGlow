<template>
  <nav class="tw-flex tw-bg-white tw-items-center tw-border-b tw-text-default/80 tw-justify-between tw-leading-4 tw-px-4">
    <ul class="tw-flex tw-items-center">
      <li class="tw-p-1 tw-py-2"><a href="/"><img src="/assets/images/logo.png" class="tw-h-12"></a></li>
      ...
      <li class="tw-px-2 hover:tw-text-default"><router-link to="/questions">Questions</router-link></li>
      <li class="tw-px-2 hover:tw-text-default" v-if="permissions.canCreateQuestion"><router-link :to="{'path': '/questions/new', 'query': {data: null}}" >New Question</router-link></li>
      <li class="tw-px-2 hover:tw-text-default"><router-link to="/data_references/databases" >Data Reference</router-link></li>
    </ul>
    <ul class="tw-flex tw-items-center">
      <li class="tw-p-2 tw-py-4">
        ...
        <q-menu flat=true transition-show="jump-down" transition-hide="jump-up" max-height="500px"
          ...
          <div class="menu-item tw-border-t tw-py-2 tw-min-w-[150px]"  v-close-popup v-if="permissions.isAdmin"> <router-link to="/settings">
