...
<template>
  <Teleport to="body">
    <div v-if="show" class="modal-mask tw-fixed tw-inset-0 tw-bg-gray-900/90 tw-flex tw-z-[99999]"
      @click="$emit('update:show', false)">
      <div class="tw-max-w-[95%] tw-max-w-[75%] tw-max-w-[35%] tw-hidden"></div>
      <div
        class="modal-container tw-rounded-2xl tw-bg-white tw-max-h-[95vh] tw-min-h-[300px] tw-min-w-[300px] tw-m-auto tw-border tw-flex"
      ...
      <div
        ...
        <div class="tw-flex-1" :class="bodyClass ? bodyClass : 'tw-overflow-y-auto'">
