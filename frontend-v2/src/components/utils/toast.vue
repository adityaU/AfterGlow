<template>
  <!-- <teleport to="body"> -->
  <div
    class="tw-flex tw-basis-8 tw-fixed tw-top-2 tw-right-2 ag-card tw-max-w-[400px] tw-z-50"
    v-if="show"
  >
    <div
      class="tw-bg-green-700 tw-flex tw-items-center tw-text-white tw-px-4 tw-rounded-l-lg"
      v-if="type == 'ok'"
    >
      <ChecksIcon size="48" />
    </div>
    <div
      class="tw-bg-orange-400 tw-flex tw-items-center tw-text-white tw-px-4 tw-rounded-l-lg"
      v-if="type == 'warning'"
    >
      <AlertCircleFilledIcon size="48" />
    </div>
    <div
      class="tw-bg-red-700 tw-flex tw-items-center tw-text-white tw-px-4 tw-rounded-l-lg"
      v-if="type == 'critical'"
    >
      <AlertCircleFilledIcon size="48" />
    </div>
