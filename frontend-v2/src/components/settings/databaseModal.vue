    ...
    >
      ...
      <template #body>
        <div class="tw-p-2 divide-y">
          ...
          <AGSelect
            v-model:selected="databaseLocal.db_type"
          ...
          <AGInput
            v-model:value="databaseLocal.name"
            placeholder="What do you call it?"
          />
          <template v-if="databaseLocal.db_type === 'clickhouse'">
            <div class="label tw-mt-2">Scheme</div>
            <AGSelect
              v-model:selected="databaseLocal.config.scheme"
              :options="schemeOptions"
              description="Select a scheme. default:  http://"
              hideSearch="true"
            />
          </template>
          ...
          <AGInput
            v-model:value="databaseLocal.config.host_url"
            placeholder="localhost"
          />

          <div class="label tw-mt-2">Host Port</div>
          <AGInput
            v-model:value="databaseLocal.config.host_port"
            placeholder="5432"
            type="number"
          />
          ...
          <AGInput
            v-model:value="databaseLocal.config.db_name"
            placeholder="dbname"
          />

          <div class="label tw-mt-2">Database Username</div>
          <AGInput
            v-model:value="databaseLocal.config.username"
            placeholder="dbusername"
          />

          <div class="label tw-mt-2">Database Password</div>
          <AGInput
            v-model:value="databaseLocal.config.password"
          ...
          <AGInput
            v-model:value="databaseLocal.config.pool_size"
          ...
          <AGInput
            v-model:value="databaseLocal.config.checkout_timeout"
            placeholder="default: 45"
          />

          <div class="label tw-mt-2">Query Timeout in Seconds</div>
          <AGInput
            v-model:value="databaseLocal.config.query_timeout"
