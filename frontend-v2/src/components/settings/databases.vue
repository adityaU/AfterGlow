      ...
      <div class="tw-bg-white tw-border tw-flex tw-items-center tw-py-2 tw-px-4 tw-gap-2 tw-rounded-2xl"
        ...
        <div class="tw-cursor-pointer tw-p-2">
          ...
          <q-menu flat="true" transition-show="scale" transition-hide="scale" max-height="900px" :offset="[0, 5]"
            ...
            auto-close>
            <div
              class="tw-cursor-pointer tw-whitespace-nowrap tw-uppercase  note tw-flex tw-items-center tw-gap-2 tw-py-1 tw-px-2 tw-w-full hover:tw-bg-primary hover: tw-text-ellipsis focus:tw-bg-primary focus: tw-border-b last:tw-border-b-0"
              @click="
