        ...
        <div class="tw-flex tw-items-center tw-m-1">
          <div class="tw-flex tw-items-center tw-cursor-pointer tw-leading-4">
            <div class="tw-flex">
              ...
              <div
                class="tw-bg-primary tw-text-white tw-px-4 tw-py-2"
              ...
              <AGDatetimePicker
                class="tw-bg-primary tw-text-white tw-px-4 tw-py-2 tw-border-0"
          ...
          <div
            class="tw-rounded-r-sm tw-bg-primary/60 tw-py-2 tw-px-4 tw-cursor-pointer tw-h-[25.6px]"
