<template>
  <div>
    <div class="tw-flex tw-cursor-pointer">
      <div class="tw-border tw-border-primary tw-px-4 !tw-py-1 tw-text-primary tw-font-semibold tw-border-2" :class="selectedDatabaseLocal?.name ? 'tw-rounded-l-full' : 'tw-rounded-full'
        ">
        Data Source
      </div>
