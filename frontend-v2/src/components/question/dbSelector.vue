<template>
  <div>
    <div class="tw-flex tw-cursor-pointer">
      <div
        class="tw-border tw-border-primary tw-px-2 tw-text-primary tw-font-semibold"
        :class="
          selectedDatabaseLocal?.name ? 'tw-rounded-l-sm' : 'tw-rounded-sm'
        "
      >
        Data Source
      </div>
      <div
        class="tw-border tw-border-primary tw-bg-primary tw-text-white tw-px-2 tw-rounded-r-sm"
