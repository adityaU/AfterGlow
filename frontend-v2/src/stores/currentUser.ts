...
export const currentUserStore = defineStore('currentUser', {
  ...
  getters: {
    ...
    canSeeDashboard() {
      return (
        this.permissions.indexOf('Dashboard.show') >= 0 ||
    ...
    canCreateDashboard() {
      return (
        (!this.viewerMode &&
          this.permissions.indexOf('Dashboard.create') >= 0) ||
        this.permissions.indexOf('Settings.all') >= 0
      );
    },
    canEditDashboard() {
      return (
        (!this.viewerMode && this.permissions.indexOf('Dashboard.edit') >= 0) ||
        this.permissions.indexOf('Settings.all') >= 0
      );
    },
    canDeleteDashboard() {
      return (
        (!this.viewerMode &&
          this.permissions.indexOf('Dashboard.delete') >= 0) ||
        this.permissions.indexOf('Settings.all') >= 0
      );
    },
    canCreateQuestion() {
      return (
        (!this.viewerMode &&
          this.permissions.indexOf('Question.create') >= 0) ||
        this.permissions.indexOf('Settings.all') >= 0
      );
    },
    canSeeQuestion() {
      return (
        this.permissions.indexOf('Question.show') >= 0 ||
        this.permissions.indexOf('Settings.all') >= 0
      );
    },
    canEditQuestion() {
      return (
        (!this.viewerMode && this.permissions.indexOf('Question.edit') >= 0) ||
        this.permissions.indexOf('Settings.all') >= 0
      );
    },
    canDeleteQuestion() {
      return (
        (!this.viewerMode &&
          this.permissions.indexOf('Question.delete') >= 0) ||
        this.permissions.indexOf('Settings.all') >= 0
      );
    },
    canDownload() {
    ...
    isEditor() {
      return (
        this.permissions.indexOf('Question.edit') >= 0 ||
        this.permissions.indexOf('Settings.all') >= 0
      );
    },
    getDetails() {
