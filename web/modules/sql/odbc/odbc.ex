defmodule AfterGlow.ODBC do
  ...
  It is used by `AfterGlow.ODBC.Protocol` and should not generally be
  accessed directly.
  """

  use GenServer

  alias AfterGlow.ODBC.Error
  ...
  def query(pid, statement, params, opts) do
    if Process.alive?(pid) do
      ...
      {:error, %AfterGlow.ODBC.Error{message: :no_connection}}
    end
  end
