defmodule AfterGlow.Sql.Adapters.QueryMakers.Common do
  defmacro __using__(_) do
    quote location: :keep do
      ...
      def parse_filter(%{"column" => nil, "operator" => op, "value" => nil,  "valueDateObj" => _valdate}), do: nil
      def parse_filter(%{"column" => col, "operator" => %{"value" => op_value, "name" => _name}, "value" => val,  "valueDateObj" => valdate}) do
        valdate = %{
          "date" => valdate["date"],
      ...
      defoverridable [stringify_select: 2, parse_filter_date_obj_value: 3, cast_group_by: 2, find_columns_required_for_select: 2, options: 2]
    end
  end
end
