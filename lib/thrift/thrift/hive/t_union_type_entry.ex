defmodule(Thrift.Hive.TUnionTypeEntry) do
  _ = "Auto-generated Thrift struct TCLIService.TUnionTypeEntry"
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Thrift.Hive.TUnionTypeEntry{})
    end
    defp(deserialize(<<0, rest::binary>>, %Thrift.Hive.TUnionTypeEntry{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Thrift.Hive.TUnionTypeEntry{name_to_type_ptr: name_to_type_ptr})) do
      [case(name_to_type_ptr) do
        nil ->
          raise(Thrift.InvalidValueException, "Required field :name_to_type_ptr on Thrift.Hive.TUnionTypeEntry must not be nil")
        _ ->
