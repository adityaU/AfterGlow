        ...
        optionsObserver: _ember['default'].on('init', _ember['default'].observer('seriesWithData', 'xName', 'yName', 'opts', function () {
            _ember['default'].run.debounce(this, function () {
                ...
                if (this.get('seriesWithData')) {
                    ...
                    this.get("multipleYs").forEach(function (item) {});
...
define('frontend/pods/components/custom-single-select-content/component', ['exports', 'ember', 'ember-keyboard-shortcuts/mixins/component'], function (exports, _ember, _emberKeyboardShortcutsMixinsComponent) {
  exports['default'] = _ember['default'].Component.extend(_emberKeyboardShortcutsMixinsComponent['default'], {
    ...
    filteredOptions: _ember['default'].computed('query', 'options', function () {
      var _this = this;
    ...
    exports['default'] = _ember['default'].Component.extend({
        ...
        transposedResults: _ember['default'].computed('pagedRows', 'page', function () {
            ...
            if (this.get('pagedRows')) {
                this.get('results.columns').forEach(function (el) {
                    transposedResults.get('content').pushObject(_ember['default'].A([el]));
                });
                this.get('pagedRows').forEach(function (el, index) {
...
if (!runningTests) {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+899baceb"});
}
