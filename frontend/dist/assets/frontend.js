      ...
      if (this.get('resultsCanBeLoaded') && !this.get('loading')) {
        ...
        if (this.get('query_type') == 'api_client' && this.get('api_action.isLoaded')) {
          this.resultsCall({
            ...
            var results = _this.parseApiActionResult(response.data, _this.get('api_action'));
            _this.set('results', results);
            _this.set('cached_results', results);
...
define("frontend/pods/components/embeddable-vue-component/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "5IpUjPOy", "block": "{\"symbols\":[],\"statements\":[[6,\"iframe\"],[9,\"class\",\"iframe\"],[10,\"src\",[18,\"vueResultPath\"],null],[10,\"onload\",[25,\"action\",[[19,0,[]],\"onLoad\"],null],null],[7],[0,\" \"],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/embeddable-vue-component/template.hbs" } });
});
    ...
    actions: {
      ...
      saveDashboard: function saveDashboard() {
        ...
        dashboard.save().then(function (response) {
          ...
          _this2.set('nonEditable', 'yes');
          _this2.set('editMode', false);
          _this2.get('dashboard').save();
        });
      },
      ...
      deleteDashboard: function deleteDashboard(dashboard) {
        ...
        dashboard.destroyRecord().then(function (response) {
          _this3.transitionToRoute('index');
        });
      },
  ...
  exports['default'] = _ember['default'].Controller.extend(_frontendMixinsLoadingMessages['default'], _frontendMixinsChartSettings['default'], _frontendMixinsHelperMixin['default'], _frontendMixinsResultViewMixin['default'], _frontendMixinsAceTools['default'], _frontendMixinsCustomEvents['default'], _frontendMixinsDynamicQueryParamsControllerMixin['default'], {
    ...
    getResultsFunction: function getResultsFunction(queryObject, withSelected) {
      ...
      this.get('ajax').apiCall({
        ...
        _this2.set('errors', null);
        if (question.get('query_type') == 'api_client') {
          var results = _this2.parseApiActionResult(response, _this2.get('question.api_action'));
          _this2.set('results', results);
        } else {
          _this2.set('results', response.data);
        }
        if (!_this2.get('resultsViewType')) {
          _this2.set('resultsViewType', _this2.autoDetect(response.data.rows));
        }
        ...
        _this2.set('isQueryLimited', response.data.limited);
        _this2.set('queryLimit', response.data.limit);
        _this2.set('limitedQuery', response.data.limited_query);
        _this2.set('variablesReplacedQuery', response.data.variables_replaced_query);
        _this2.scrollToResultsView();
      }, function (error, status) {
        _this2.set('loading', false);
        _this2.scrollToResultsView();
        error && error.error ? _this2.set('errors', error.error) : _this2.set('errors', {
        ...
        _this2.set('isQueryLimited', null);
        _this2.set('queryLimit', null);
        _this2.set('limitQuery', null);
        _this2.set('variablesReplacedQuery', error.error.variables_replaced_query);
      });
      // }
    },
...
if (!runningTests) {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+66180492"});
}
