...
define('frontend/abilities/question', ['exports', 'ember', 'ember-can'], function (exports, _ember, _emberCan) {
    exports['default'] = _emberCan.Ability.extend({
        ...
        canDownload: _ember['default'].computed('sessionService.permissions', function () {
...
define('frontend/components/bs-datetimepicker', ['exports', 'ember-cli-bootstrap4-datetimepicker/components/bs-datetimepicker', 'frontend/config/environment'], function (exports, _emberCliBootstrap4DatetimepickerComponentsBsDatetimepicker, _frontendConfigEnvironment) {
  exports['default'] = _emberCliBootstrap4DatetimepickerComponentsBsDatetimepicker['default'].extend({
    config: _frontendConfigEnvironment['default']['ember-cli-bootstrap4-datetimepicker']
  });
});
...
define('frontend/components/bs-form/element/control/radio', ['exports', 'ember-bootstrap/components/bs-form/element/control/radio'], function (exports, _emberBootstrapComponentsBsFormElementControlRadio) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
      return _emberBootstrapComponentsBsFormElementControlRadio['default'];
    }
  });
});
  ...
  exports['default'] = _ember['default'].Helper.extend({
    compute: function compute(params /*, hash*/) {
      if (params && (params[0] || params[0] == 0 || params[0] == false)) {
        ...
        var negetiveNumber = Math.abs(params) != params && Math.abs(params).toString() != 'NaN';
        var date = Date.parse(params);
        var dateMatch = params.toString().match('-') != null;
        if (date.toString() != 'NaN' && dateMatch && !negetiveNumber) {
          date = moment(date);
...
define('frontend/helpers/is-empty', ['exports', 'ember'], function (exports, _ember) {
  var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();
...
define('frontend/helpers/is-order-applied', ['exports', 'ember'], function (exports, _ember) {
    var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();
    ...
    exports['default'] = _ember['default'].Helper.extend({
        ...
        compute: function compute(_ref) {
            ...
            var orderBys = _ref2[0];
            var column_name = _ref2[1];
            var order = _ref2[2];

            var applied = false;
            orderBys && orderBys.every(function (orderBy) {
...
define('frontend/helpers/label-maker', ['exports', 'ember', 'frontend/helpers/format-object', 'frontend/helpers/capitalize'], function (exports, _ember, _frontendHelpersFormatObject, _frontendHelpersCapitalize) {
    var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();

    function isGroupByDateType(obj) {

        var dataType = obj.get('selected.data_type');
    ...
    exports['default'] = _ember['default'].Helper.extend({
        ...
        compute: function compute(_ref) {
            ...
            var formatObject = new _frontendHelpersFormatObject['default']();
            var capitalize = new _frontendHelpersCapitalize['default']();

            var label = obj.get('selected.human_name') || obj.get('selected.name') || obj.get('selected.value') || obj.get('selected.raw') && obj.get('selected.raw').toString();
...
define('frontend/helpers/localize', ['exports', 'ember', 'frontend/helpers/format-object'], function (exports, _ember, _frontendHelpersFormatObject) {
    exports['default'] = _ember['default'].Helper.extend({
        compute: function compute(params /*, hash*/) {
            if (params && params.length > 0 && params[0]) {
                var number = +params[0];
                if (number.toString() != 'NaN') {
                    ...
                    return new _frontendHelpersFormatObject['default']().compute(params);
                }
            }
        }
    });
        ...
        suggestAutoCompletions: function suggestAutoCompletions(editor, session, position, prefix, context, callback) {
            if (context && context.get('id')) {
                this.get('ajax').apiCall({
                    url: this.get('ajax.apiPath') + '/sql_autocomplete' + "?database_id=" + context.get('id') + "&prefix=" + prefix + "&query=" + session.getValue(),
                    type: 'GET'
...
define('frontend/mixins/dynamic-query-params-controller-mixin', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Mixin.create({
    queryParams: _ember['default'].computed('queryParamsVariables.@each.name', function () {
      var queryParams = this.get('queryParamsVariables') && this.get('queryParamsVariables').map(function (variable) {
    ...
    changeQueryParamsInUrl: function changeQueryParamsInUrl(variables, title) {
      ...
      variables && variables.forEach(function (variable) {
        var var_name = variable.get && variable.get('name') || variable.name;
        var var_value = variable.get && variable.get('value') || variable.value;
        if (var_name && var_value && var_name != 'undefined' && var_name != undefined && var_value != undefined && var_value != 'undefined') {
          _this2.set('q_' + var_name, var_value);
        }
      });
      var newQueryParams = {};
...
define('frontend/mixins/filter-operator-mixin', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Mixin.create({
    getDefaultValuesforColumn: function getDefaultValuesforColumn(columnDataType) {
    ...
    guessDataType: function guessDataType(value) {
    ...
    findAvailableOperators: function findAvailableOperators(value) {

      var dataType = this.guessDataType(value);
      var operators = [];
      if (dataType == 'string') {
      ...
      return this.get('operators').filter(function (item) {
    ...
    operators: [{ name: 'is greater than', value: '>' }, { name: 'is less than', value: '<' }, { name: 'is greater than or equals to', value: '>=' }, { name: 'is less than or equals to', value: '<=' }, { name: 'matches', value: 'matches' }, { name: 'starts_with', value: 'starts with' }, { name: 'ends_with', value: 'ends with' }, { name: 'is nil', value: 'is NULL' }, { name: 'is not nil', value: 'is not NULL' }, { name: 'is', value: '=' }, { name: 'is not ', value: '!=' }]
  });
});
...
define('frontend/mixins/result-view-mixin', ['exports', 'ember', 'frontend/mixins/helper-mixin'], function (exports, _ember, _frontendMixinsHelperMixin) {
  exports['default'] = _ember['default'].Mixin.create(_frontendMixinsHelperMixin['default'], {
    resultViewIcons: {
    ...
    isDisplayable: function isDisplayable(params) {
      var objType = Object.prototype.toString.call(params).replace(/\[object|\]/g, '').trim();
      if (objType == 'Object') {
        return "Object";
      } else if (objType == 'Array') {
    ...
    parseApiActionResult: function parseApiActionResult(response, apiAction) {
      var displayKey = apiAction.get('response_settings.displayKey.key');
      var displayType = apiAction.get('response_settings.displayKey.objType');
      var arrayKeys = displayKey.split(".").filter(function (key) {
        return key != "root";
      }).join(".");
      if (arrayKeys == "") {
        arrayKeys = ".";
      ...
      var data = this.jsonPath(responseBody, arrayKeys);
      var results = {};
      if (data) {
        if (displayType == 'Object') {
          data = data && data[0];
          results['columns'] = Object.keys(data);
          results['rows'] = [results['columns'].length > 0 && results['columns'].map(function (key) {
            return data[key];
          })].filter(function (row) {
            return row;
          });
          ...
          data.forEach(function (obj) {
            console.log(obj);
            results['rows'].push(results['columns'].map(function (key) {
              return obj[key];
            }));
          });
        }
    ...
    jsonPath: function jsonPath(obj, expr, arg) {
      var P = {
...
define('frontend/models/api-action', ['exports', 'ember-data', 'ember-api-actions'], function (exports, _emberData, _emberApiActions) {
  exports['default'] = _emberData['default'].Model.extend({
    question: _emberData['default'].belongsTo('question'),
    top_level_question: _emberData['default'].belongsTo('question'),
    ...
    preview: (0, _emberApiActions.collectionAction)({
      path: 'send_request',
      type: 'post',
      urlType: 'findRecord'
    })
...
define('frontend/models/question', ['exports', 'ember-data', 'ember-api-actions', 'frontend/mixins/result-view-mixin'], function (exports, _emberData, _emberApiActions, _frontendMixinsResultViewMixin) {
  exports['default'] = _emberData['default'].Model.extend(_frontendMixinsResultViewMixin['default'], {
    ...
    api_actions: _emberData['default'].hasMany('api_action', { inverse: "question" }),
    api_action: _emberData['default'].belongsTo('api_action', { inverse: 'top_level_question' }),
    ...
    mergedVariables: Ember.computed('dashboardVariables.@each', 'query_variables', function () {
      ...
      this.get('dashboardVariables') && this.get('dashboardVariables').forEach(function (item) {
        var query_var = _this.get('query_variables').findBy('name', item.get('name'));
        query_var && _this.get('query_variables').removeObject(query_var);
        query_var && _this.get('query_variables').pushObject(item);
      });
...
define("frontend/pods/application/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "AL74XNp8", "block": "{\"symbols\":[],\"statements\":[[1,[25,\"base-header\",null,[[\"goToDashboard\",\"invalidateSession\",\"openSearch\"],[\"goToDashboard\",\"invalidateSession\",\"openSearch\"]]],false],[0,\"\\n\\n\"],[1,[18,\"outlet\"],false],[0,\"\\n\"],[6,\"div\"],[9,\"class\",\"pb-8\"],[7],[0,\"\\n\"],[8],[0,\"\\n\"],[1,[18,\"base-footer\"],false],[0,\"\\n\"],[1,[18,\"keyboard-shortcuts-help\"],false],[0,\"\\n\"],[4,\"if\",[[20,[\"showSearch\"]]],null,{\"statements\":[[1,[25,\"search-box\",null,[[\"goToDashboard\",\"goToQuestion\",\"goToTag\"],[\"goToDashboard\",\"goToQuestion\",\"goToTag\"]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[1,[18,\"vim-easymotion\"],false]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/application/template.hbs" } });
});
...
define('frontend/pods/components/additional-filters/component', ['exports', 'ember', 'frontend/mixins/filter-operator-mixin'], function (exports, _ember, _frontendMixinsFilterOperatorMixin) {
  exports['default'] = _ember['default'].Component.extend(_frontendMixinsFilterOperatorMixin['default'], {
    classNames: ['w-100'],
    ...
    figureOutDataType: function figureOutDataType(index) {
      ...
      this.get('results.rows').every(function (row) {
        if (row[index] || row[index] == 0) {
          dataType = _this3.guessDataType(row[index]);
          return false;
        }
        return true;
      });
...
define("frontend/pods/components/additional-filters/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "KPUYC0Hh", "block": "{\"symbols\":[\"dd\",\"orderBy\",\"dd\",\"dd\",\"groupBy\",\"dd\",\"dd\",\"selectView\",\"dd\",\"dd\",\"filter\",\"dd\"],\"statements\":[[6,\"div\"],[9,\"class\",\"row w-100\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"col-11\"],[7],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n\\n            \"],[6,\"div\"],[9,\"class\",\"col-auto border-right p-1 min-width-15\"],[7],[0,\"\\n\\n\"],[4,\"each\",[[20,[\"queryObject\",\"additionalFilters\",\"filters\"]]],null,{\"statements\":[[4,\"if\",[[25,\"label-maker\",[[19,11,[]],[19,11,[\"column\"]],[19,11,[\"value\"]],[19,11,[\"valueDateObj\",\"value\"]],[19,11,[\"valueDateObj\",\"duration\"]],[19,11,[\"operator\"]],[19,11,[\"valueDateObj\",\"date\"]],[19,11,[\"valueDateObj\",\"dtt\",\"name\"]]],null]],null,{\"statements\":[[0,\"                \"],[6,\"span\"],[9,\"class\",\"tag border tag-primary mt-0\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,12,[\"toggle\"]]],[[\"class\"],[\"text-white\"]],{\"statements\":[[0,\"                    \"],[1,[25,\"label-maker\",[[19,11,[]],[19,11,[\"column\"]],[19,11,[\"value\"]],[19,11,[\"valueDateObj\",\"value\"]],[19,11,[\"valueDateObj\",\"duration\"]],[19,11,[\"operator\"]],[19,11,[\"valueDateObj\",\"date\"]],[19,11,[\"valueDateObj\",\"dtt\",\"name\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"                    \"],[1,[25,\"filter-maker\",null,[[\"dd\",\"filter\",\"columns\",\"results\",\"switchToBuilder\",\"switchToRaw\"],[[19,12,[]],[19,11,[]],[20,[\"columns\"]],[20,[\"results\"]],\"switchToBuilder\",\"switchToRaw\"]]],false],[0,\"\\n\"]],\"parameters\":[12]},null],[0,\"                    \"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"tag-addon\"],[7],[0,\"\\n                        \"],[6,\"i\"],[9,\"class\",\"fe fe-x text-white\"],[3,\"action\",[[19,0,[]],\"remove\",\"filters\",[19,11,[]]]],[7],[8],[0,\"\\n                    \"],[8],[0,\"\\n                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[11]},null],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,10,[\"toggle\"]]],[[\"class\"],[\"btn tag-size mt-0 btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[0,\"                \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\" Filter\\n\"]],\"parameters\":[]},null],[0,\"                \"],[1,[25,\"filter-maker\",null,[[\"dd\",\"showAddFilter\",\"results\",\"addNewFilter\",\"filter\",\"columns\",\"switchToBuilder\",\"switchToRaw\"],[[19,10,[]],true,[20,[\"results\"]],\"addNewFilter\",[20,[\"newFilter\"]],[20,[\"columns\"]],\"switchToBuilder\",\"switchToRaw\"]]],false],[0,\"\\n\"]],\"parameters\":[10]},null],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-auto border-right p-1 min-width-15\"],[7],[0,\"\\n\\n\"],[4,\"each\",[[20,[\"queryObject\",\"additionalFilters\",\"views\"]]],null,{\"statements\":[[4,\"if\",[[25,\"label-maker\",[[19,8,[]],[19,8,[\"selected\",\"raw\"]],[19,8,[\"selected\",\"value\"]],[19,8,[\"selected\",\"name\"]],[19,8,[\"selected\"]]],null]],null,{\"statements\":[[0,\"                \"],[6,\"span\"],[9,\"class\",\"tag tag-primary border mt-0\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,9,[\"toggle\"]]],[[\"class\"],[\"text-white\"]],{\"statements\":[[0,\"                    \"],[1,[25,\"label-maker\",[[19,8,[]],[19,8,[\"selected\"]],[19,8,[\"selected\",\"value\"]],[19,8,[\"selected\",\"raw\"]],[19,8,[\"selected\",\"name\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"                    \"],[1,[25,\"view-maker\",null,[[\"dd\",\"addNewView\",\"selectView\",\"switchToBuilder\",\"switchToRaw\"],[[19,9,[]],\"addNewView\",[19,8,[]],\"switchToBuilder\",\"switchToRaw\"]]],false],[0,\"\\n\"]],\"parameters\":[9]},null],[0,\"                    \"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"tag-addon\"],[7],[0,\"\\n                        \"],[6,\"i\"],[9,\"class\",\"fe fe-x text-white\"],[3,\"action\",[[19,0,[]],\"remove\",\"views\",[19,8,[]]]],[7],[8],[0,\"\\n                    \"],[8],[0,\"\\n                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[8]},null],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,7,[\"toggle\"]]],[[\"class\"],[\"btn tag-size mt-0 btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[0,\"                \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"View\\n\"]],\"parameters\":[]},null],[0,\"                \"],[1,[25,\"view-maker\",null,[[\"dd\",\"showAddView\",\"addNewView\",\"selectView\",\"switchToBuilder\",\"switchToRaw\"],[[19,7,[]],true,\"addNewView\",[20,[\"newView\"]],\"switchToBuilder\",\"switchToRaw\"]]],false],[0,\"\\n\"]],\"parameters\":[7]},null],[0,\"            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-auto border-right p-1 min-width-15\"],[7],[0,\"\\n\\n\"],[4,\"each\",[[20,[\"queryObject\",\"additionalFilters\",\"groupBys\"]]],null,{\"statements\":[[4,\"if\",[[25,\"label-maker\",[[19,5,[]],[19,5,[\"castType\"]],[19,5,[\"selected\"]],[19,5,[\"selected\",\"value\"]],[19,5,[\"selected\",\"raw\"]]],null]],null,{\"statements\":[[0,\"                \"],[6,\"span\"],[9,\"class\",\"tag border tag-primary mt-0\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,6,[\"toggle\"]]],[[\"class\"],[\"text-white\"]],{\"statements\":[[0,\"                    \"],[1,[25,\"label-maker\",[[19,5,[]],[19,5,[\"castType\"]],[19,5,[\"selected\"]],[19,5,[\"selected\",\"value\"]],[19,5,[\"selected\",\"raw\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"                    \"],[1,[25,\"group-by-maker\",null,[[\"dd\",\"columns\",\"groupBy\",\"switchToRaw\",\"switchToBuilder\"],[[19,6,[]],[20,[\"columns\"]],[19,5,[]],\"switchToRaw\",\"switchToBuilder\"]]],false],[0,\"\\n\"]],\"parameters\":[6]},null],[0,\"                    \"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"tag-addon\"],[7],[0,\"\\n                        \"],[6,\"i\"],[9,\"class\",\"fe fe-x text-white\"],[3,\"action\",[[19,0,[]],\"remove\",\"groupBys\",[19,5,[]]]],[7],[8],[0,\"\\n                    \"],[8],[0,\"\\n                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[5]},null],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,4,[\"toggle\"]]],[[\"class\"],[\"btn tag-size mt-0 btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[0,\"                \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"Grouping\\n\"]],\"parameters\":[]},null],[0,\"                \"],[1,[25,\"group-by-maker\",null,[[\"dd\",\"showAddGroupBy\",\"addNewGroupBy\",\"columns\",\"groupBy\",\"switchToRaw\",\"switchToBuilder\"],[[19,4,[]],true,\"addNewGroupBy\",[20,[\"columns\"]],[20,[\"newGroupBy\"]],\"switchToRaw\",\"switchToBuilder\"]]],false],[0,\"\\n\"]],\"parameters\":[4]},null],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-auto p-1 min-width-15\"],[7],[0,\"\\n\\n\"],[4,\"each\",[[20,[\"queryObject\",\"additionalFilters\",\"orderBys\"]]],null,{\"statements\":[[4,\"if\",[[25,\"label-maker\",[[19,2,[]],[19,2,[\"column\"]],[19,2,[\"order\"]]],null]],null,{\"statements\":[[0,\"                \"],[6,\"span\"],[9,\"class\",\"tag border tag-primary mt-0\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,3,[\"toggle\"]]],[[\"class\"],[\"text-white\"]],{\"statements\":[[0,\"                    \"],[1,[25,\"label-maker\",[[19,2,[]],[19,2,[\"column\"]],[19,2,[\"order\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n                    \"],[1,[25,\"order-by-maker\",null,[[\"dd\",\"columns\",\"orderBy\"],[[19,3,[]],[20,[\"columns\"]],[19,2,[]]]]],false],[0,\"\\n\"]],\"parameters\":[3]},null],[0,\"                    \"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"tag-addon\"],[7],[0,\"\\n                        \"],[6,\"i\"],[9,\"class\",\"fe fe-x text-white\"],[3,\"action\",[[19,0,[]],\"remove\",\"orderBys\",[19,2,[]]]],[7],[8],[0,\"\\n                    \"],[8],[0,\"\\n                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[2]},null],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,1,[\"toggle\"]]],[[\"class\"],[\"btn tag-size mt-0 btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[0,\"                \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"Sort Order\\n\"]],\"parameters\":[]},null],[0,\"                \"],[1,[25,\"order-by-maker\",null,[[\"dd\",\"showAddOrderBy\",\"addNewOrderBy\",\"columns\",\"orderBy\"],[[19,1,[]],true,\"addNewOrderBy\",[20,[\"columns\"]],[20,[\"newOrderBy\"]]]]],false],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"col-1 text-right\"],[7],[0,\"\\n        \"],[6,\"span\"],[3,\"action\",[[19,0,[]],\"resetAdditionalFilters\"]],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"btn btn-link p-0\"],[7],[0,\" Clear\\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\\n    \"],[8],[0,\"\\n\"],[8]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/additional-filters/template.hbs" } });
});
define('frontend/pods/components/additional-quick-filters/component', ['exports', 'ember', 'frontend/mixins/filter-operator-mixin'], function (exports, _ember, _frontendMixinsFilterOperatorMixin) {
  exports['default'] = _ember['default'].Component.extend(_frontendMixinsFilterOperatorMixin['default'], {
    column: _ember['default'].computed('results', 'index', function () {
      var index = this.get('index');
      var columns = this.get('results.columns');
      return columns[index];
    }),

    noGroupBysInAdditionalFilters: _ember['default'].computed('additionalFilters.groupBys.@each.column.name', 'column', function () {
      var groupBys = this.get('additionalFilters.groupBys');
      return groupBys && groupBys.length == 0;
    }),

    columnObj: _ember['default'].computed('column', function () {
    ...
    figureOutDataType: function figureOutDataType() {
      var rows = this.get('results.rows');
      var columns = this.get('results.columns');
      var index = columns.indexOf(this.get('column'));
    ...
    filterObj: _ember['default'].computed('additionalFilters.filters.@each.column.name', 'results', 'column', 'value', function () {
      var _this = this;

      var filters = this.get('additionalFilters.filters');
      var obj = null;
      filters && filters.every(function (filter) {

        if (filter.get('column.name') == _this.get('column') && filter.get('value') == _this.get('value')) {
          obj = filter;
          return false;
        }
        return true;
    ...
    availableOperators: _ember['default'].computed('value', function () {
      return this.findAvailableOperators(this.get('value'));
    }),

    actions: {
      addFilter: function addFilter(operator) {
...
define("frontend/pods/components/additional-quick-filters/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "VuIseFlT", "block": "{\"symbols\":[\"operator\"],\"statements\":[[4,\"if\",[[25,\"exists-in\",[[20,[\"index\"]],[20,[\"results\"]]],null]],null,{\"statements\":[[6,\"div\"],[9,\"class\",\"card-body p-2\"],[7],[0,\"\\n\"],[4,\"link-to\",[\"explore.new\",[25,\"get-column-id\",[[20,[\"index\"]],[20,[\"results\"]]],null],[20,[\"value\"]]],[[\"target\"],[\"_\"]],{\"statements\":[[0,\"    View Details\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[6,\"div\"],[9,\"class\",\"card-body p-2\"],[7],[0,\"\\n\\n\"],[4,\"copy-button\",null,[[\"class\",\"clipboardText\"],[\"btn btn-link p-0\",[20,[\"value\"]]]],{\"statements\":[[0,\"    Copy Exact Value\\n\"]],\"parameters\":[]},null],[8],[0,\"\\n\\n\"],[6,\"div\"],[9,\"class\",\"card-body p-2\"],[7],[0,\"\\n\"],[4,\"copy-button\",null,[[\"class\",\"clipboardText\"],[\"btn btn-link p-0\",[25,\"format-object\",[[20,[\"value\"]]],null]]],{\"statements\":[[0,\"    Copy Formated Value\\n\"]],\"parameters\":[]},null],[8],[0,\"\\n\"],[4,\"if\",[[25,\"and\",[[20,[\"showQuickFilters\"]],[20,[\"noGroupBysInAdditionalFilters\"]]],null]],null,{\"statements\":[[4,\"unless\",[[25,\"is-empty\",[[20,[\"availableOperators\"]]],null]],null,{\"statements\":[[6,\"div\"],[9,\"class\",\"card-body p-2\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"tags\"],[7],[0,\"\\n        Quick Filters:\\n\"],[4,\"each\",[[20,[\"availableOperators\"]]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[9,\"class\",\"tag\"],[3,\"action\",[[19,0,[]],\"addFilter\",[19,1,[]]]],[7],[0,\"\\n            \"],[1,[19,1,[\"value\"]],false],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"    \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/additional-quick-filters/template.hbs" } });
});
define('frontend/pods/components/additional-sort-and-grouping/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ascendingOrderObj: _ember['default'].computed('additionalFilters.orderBys.@each.order.value', 'columnObj', function () {
      var column = this.get('column');
      var obj = null;
      this.get('additionalFilters.orderBys') && this.get('additionalFilters.orderBys').every(function (orderBy) {
    ...
    descendingOrderObj: _ember['default'].computed('additionalFilters.orderBys.@each.order.value', 'columnObj', function () {
      var column = this.get('column');
      var obj = null;
      this.get('additionalFilters.orderBys') && this.get('additionalFilters.orderBys').every(function (orderBy) {
    ...
    showGroupBy: _ember['default'].computed('additionalFilters.groupBys.[]', 'columnObj', function () {
      var column = this.get('column');
      var show = true;
      this.get('additionalFilters.groupBys') && this.get('additionalFilters.groupBys').every(function (groupBy) {
    ...
    addCountView: function addCountView() {},
    actions: {
      addAscendingOrder: function addAscendingOrder() {
        if (this.get('descendingOrderObj')) {
          this.set('descendingOrderObj.order', _ember['default'].Object.create({ name: 'Ascending', value: 'ASC' }));
        } else {

          this.get('additionalFilters.orderBys').pushObject(_ember['default'].Object.create({
            column: this.get('columnObj'),
            order: _ember['default'].Object.create({
              name: 'Ascending',
              value: 'ASC'
            })
          }));
      ...
      addDescendingOrder: function addDescendingOrder() {
        if (this.get('ascendingOrderObj')) {
          this.set('ascendingOrderObj.order', _ember['default'].Object.create({ name: 'Descending', value: 'DESC' }));
        } else {
      ...
      addGroupBy: function addGroupBy(value) {
        if (value) {
          this.get('additionalFilters.groupBys').pushObject(_ember['default'].Object.create({ selected: this.get('columnObj'), castType: value }));
        } else {

          this.get('additionalFilters.groupBys').pushObject(_ember['default'].Object.create({ selected: this.get('columnObj') }));
        }
        this.get('additionalFilters.views').pushObject(_ember['default'].Object.create({ selected: { name: 'Count', value: 'count' } }));
...
define("frontend/pods/components/additional-sort-and-grouping/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "sLT2gdW7", "block": "{\"symbols\":[],\"statements\":[[4,\"if\",[[20,[\"showGroupBy\"]]],null,{\"statements\":[[6,\"div\"],[9,\"class\",\"card-body p-2\"],[7],[0,\"\\n\"],[4,\"unless\",[[25,\"eq\",[[20,[\"columnObj\",\"data_type\"]],\"datetime\"],null]],null,{\"statements\":[[0,\"    \"],[6,\"a\"],[9,\"href\",\"#\"],[3,\"action\",[[19,0,[]],\"addGroupBy\"]],[7],[0,\"\\n        View Distribution by \"],[1,[25,\"capitalize\",[[20,[\"column\"]]],null],false],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[6,\"small\"],[9,\"class\",\"text-muted\"],[7],[0,\"\\n        View Distribution by \"],[1,[25,\"capitalize\",[[20,[\"column\"]]],null],false],[0,\"\\n    \"],[8],[0,\"\\n    \"],[1,[25,\"custom-single-select-content\",null,[[\"hideSearch\",\"widgetType\",\"dd\",\"ddm\",\"selectCallbackAction\",\"options\",\"displayKey\"],[true,\"boxes\",[20,[\"dd\"]],[20,[\"ddm\"]],\"addGroupBy\",[20,[\"groupByDateTypes\"]],\"name\"]]],false],[0,\"\\n\"]],\"parameters\":[]}],[8],[0,\"\\n\"]],\"parameters\":[]},null],[6,\"div\"],[9,\"class\",\"card-body p-2\"],[7],[0,\"\\n    \"],[6,\"small\"],[9,\"class\",\"text-muted\"],[7],[0,\"Sort By \"],[1,[25,\"capitalize\",[[20,[\"column\"]]],null],false],[0,\": \"],[8],[0,\"\\n\"],[4,\"unless\",[[20,[\"ascendingOrderObj\"]]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"tag\"],[3,\"action\",[[19,0,[]],\"addAscendingOrder\"]],[7],[0,\"Ascending\"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"unless\",[[20,[\"descendingOrderObj\"]]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"tag\"],[3,\"action\",[[19,0,[]],\"addDescendingOrder\"]],[7],[0,\"Descending\"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[8]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/additional-sort-and-grouping/template.hbs" } });
});
...
define('frontend/pods/components/api-action-modal/component', ['exports', 'ember', 'frontend/mixins/result-view-mixin', 'frontend/mixins/helper-mixin'], function (exports, _ember, _frontendMixinsResultViewMixin, _frontendMixinsHelperMixin) {
  exports['default'] = _ember['default'].Component.extend(_frontendMixinsResultViewMixin['default'], _frontendMixinsHelperMixin['default'], {
    open: false,
    ...
    getDisplayableKeys: function getDisplayableKeys(obj, root, keys, isArray) {
      var _this2 = this;

      var _loop = function (prop) {
        var fullKeyPath = root + "." + prop;
        var objType = _this2.isDisplayable(obj[prop]);
        if (objType) {
          keys.pushObject(_ember['default'].Object.create({ key: fullKeyPath, objType: isArray ? 'Array' : objType }));
        }
        if (_this2.isDisplayable(obj[prop]) == 'Object') {
          _this2.getDisplayableKeys(obj[prop], fullKeyPath, keys);
        } else if (_this2.isDisplayable(obj[prop]) == 'Array') {
          obj[prop].forEach(function (item) {
            _this2.getDisplayableKeys(item, fullKeyPath + ".[*]", keys, true);
          });
        }
      };
    ...
    actions: {
      ...
      previewAction: function previewAction() {
        ...
        this.get('apiAction').preview(this.get('apiAction')).then(function (response) {
          var result;
          var displayableKeys = _ember['default'].A([]);
          _this4.set('loadError', false);
          _this4.set('results', null);
          try {
            result = JSON.parse(response.response_body);
            var rootKey = 'root';
            displayableKeys.pushObject(_ember['default'].Object.create({ key: 'root', objType: _this4.isDisplayable(response) }));
            displayableKeys = _this4.getDisplayableKeys(result, rootKey, displayableKeys);
            _this4.set('results', response);
            _this4.set('resultViewPossibleKeys', _this4.uniqueByProperty(displayableKeys, "key"));
          } catch (e) {
            console.log(e);
            console.log("============================");
            _this4.set('loadError', true);
            _this4.set('resultViewPossibleKeys', []);
          }
          _this4.set('openPreview', true);
          _this4.set('open', false);
        });
      }
    }
  });
...
define('frontend/pods/components/api-action-result/component', ['exports', 'ember'], function (exports, _ember) {
    exports['default'] = _ember['default'].Component.extend({
        ...
        saveEnabled: _ember['default'].computed('apiAction.response_settings.displayKey', function () {
            var displayKey = this.get('apiAction.response_settings.displayKey');
            return !!displayKey;
        }),
        ...
        actions: {
            ...
            save: function save() {
                ...
                this.get('question').save().then(function (response) {
                    _this.get('apiAction').save().then(function (response) {
                        _this.sendAction("transitionToQuestion", _this.get('question.id'));
...
define("frontend/pods/components/api-action-result/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "yVoTDxA2", "block": "{\"symbols\":[\"modal\",\"dd\",\"dd\",\"acc\"],\"statements\":[[4,\"bs-modal\",null,[[\"position\",\"size\",\"open\",\"onHide\"],[\"center\",\"lg\",[20,[\"open\"]],[25,\"action\",[[19,0,[]],\"clear\"],null]]],{\"statements\":[[4,\"component\",[[19,1,[\"header\"]]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[9,\"class\",\"row w-100\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-9\"],[7],[0,\"\\n                \"],[6,\"h4\"],[9,\"class\",\"modal-title\"],[7],[0,\" Result\"],[8],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-3 text-right\"],[7],[0,\"\\n                \"],[6,\"a\"],[9,\"href\",\"#\"],[10,\"class\",[26,[\"tag bg-\",[20,[\"status\",\"color\"]],\" text-white\"]]],[7],[1,[20,[\"status\",\"text\"]],false],[8],[0,\"\\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[19,1,[\"body\"]]],null,{\"statements\":[[4,\"if\",[[20,[\"canDebug\"]]],null,{\"statements\":[[4,\"bs-accordion\",null,null,{\"statements\":[[4,\"component\",[[19,4,[\"item\"]]],[[\"value\",\"title\"],[1,\"Debug info\"]],{\"statements\":[[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"ace-resizable\"],[7],[0,\"\\n                    \"],[1,[25,\"ember-ace\",null,[[\"value\",\"mode\",\"readOnly\",\"useWrapMode\",\"showLineNumbers\",\"ready\"],[[20,[\"debugResponse\"]],\"json\",true,true,false,[25,\"action\",[[19,0,[]],\"setEditorWhenReady\"],null]]]],false],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[4]},null]],\"parameters\":[]},null],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"ace-resizable\"],[7],[0,\"\\n        \"],[1,[25,\"ember-ace\",null,[[\"value\",\"mode\",\"readOnly\",\"useWrapMode\",\"ready\",\"showLineNumbers\"],[[20,[\"responseBody\"]],\"json\",true,true,[25,\"action\",[[19,0,[]],\"setEditorWhenReady\"],null],false]]],false],[0,\"\\n\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[19,1,[\"footer\"]]],null,{\"statements\":[[0,\"        \\n\"],[4,\"if\",[[20,[\"resultViewPossibleKeys\"]]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[9,\"class\",\"row w-100\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-12\"],[7],[0,\"\\n                \"],[6,\"h4\"],[9,\"class\",\"title\"],[7],[0,\" Select Key\"],[8],[0,\"\\n                \"],[6,\"small\"],[9,\"class\",\"text-muted\"],[7],[0,\"This key will be used to walk the json data returned by json api to display results in a table\"],[8],[0,\"\\n\\n                \"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"                \\n\"],[4,\"if\",[[20,[\"apiAction\",\"response_settings\",\"displayKey\"]]],null,{\"statements\":[[6,\"span\"],[9,\"class\",\"tag border text-primary border-primary  bg-white\"],[7],[0,\"\\n    Select Key:\\n    \"],[6,\"div\"],[9,\"class\",\"tag-addon text-white border-primary bg-primary\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,3,[\"toggle\"]]],[[\"class\"],[\"text-white \"]],{\"statements\":[[0,\"        \"],[1,[20,[\"apiAction\",\"response_settings\",\"displayKey\",\"key\"]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"        \"],[1,[25,\"custom-single-select\",null,[[\"dd\",\"icon\",\"value\",\"options\",\"displayKey\"],[[19,3,[]],\"fe-corner-down-right\",[20,[\"apiAction\",\"response_settings\",\"displayKey\"]],[20,[\"resultViewPossibleKeys\"]],\"key\"]]],false],[0,\"\\n\"]],\"parameters\":[3]},null],[0,\"\\n    \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,2,[\"toggle\"]]],[[\"id\",\"class\"],[\"datasource-selector\",\"btn tag-size  btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\" Select Key\\n\"]],\"parameters\":[]},null],[1,[25,\"custom-single-select\",null,[[\"elseMessage\",\"elseClass\",\"dd\",\"icon\",\"value\",\"options\",\"displayKey\"],[\"No valid key was founf in the response to display results in a table. Make sure your api returns json object\",\"menu-content\",[19,2,[]],\"fe-corner-down-right\",[20,[\"apiAction\",\"response_settings\",\"displayKey\"]],[20,[\"resultViewPossibleKeys\"]],\"key\"]]],false],[0,\"\\n\"]],\"parameters\":[2]},null]],\"parameters\":[]}],[0,\"                \"],[8],[0,\"\\n                \\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\\n\"],[4,\"if\",[[20,[\"saveEnabled\"]]],null,{\"statements\":[[0,\"  \"],[4,\"bs-button\",null,[[\"onClick\",\"class\",\"type\"],[[25,\"action\",[[19,0,[]],\"save\"],null],\"btn-primary\",\"primary\"]],{\"statements\":[[0,\"Save\"]],\"parameters\":[]},null],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null]],\"parameters\":[]},null]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/api-action-result/template.hbs" } });
});
...
define("frontend/pods/components/base-footer/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "VaHjxs8p", "block": "{\"symbols\":[],\"statements\":[[6,\"footer\"],[9,\"class\",\"footer p-2\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"container p-0\"],[7],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"row text-center text-lg-left\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-lg-6\"],[7],[0,\"\\n                \"],[6,\"p\"],[7],[0,\"© 2022 \"],[6,\"a\"],[9,\"href\",\"http://getafterglow.in\"],[9,\"target\",\"_\"],[9,\"class\",\"text-primary\"],[7],[0,\"getafterglow.in\"],[8],[8],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-lg-6 text-lg-right\"],[7],[0,\"\\n                \"],[6,\"a\"],[9,\"href\",\"http://getafterglow.in/docs\"],[9,\"target\",\"_\"],[9,\"class\",\"text-primary\"],[7],[0,\"Documentation\"],[8],[0,\"\\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/base-footer/template.hbs" } });
});
...
define('frontend/pods/components/custom-single-select-content/component', ['exports', 'ember', 'ember-keyboard-shortcuts/mixins/component'], function (exports, _ember, _emberKeyboardShortcutsMixinsComponent) {
  exports['default'] = _ember['default'].Component.extend(_emberKeyboardShortcutsMixinsComponent['default'], {
    ...
    filteredOptions: _ember['default'].computed('query', 'options.@each', function () {
      var _this = this;
      ...
      if (query && query != '') {
        var filteredOptions = options.filter(function (item) {
          if (item.get) {
            return item.get(_this.get('displayKey')) && item.get(_this.get('displayKey')).toLowerCase().match(query.toLowerCase());
          }
          return item[_this.get('displayKey')] && item[_this.get('displayKey')].toLowerCase().match(query.toLowerCase());
        });
    ...
    selectOptionFunc: function selectOptionFunc(option) {
    ...
    actions: {
      ...
      selectByCurrentIndex: function selectByCurrentIndex() {
        var option = this.get('filteredOptions').objectAt(this.get('selectedIndex'));
        this.selectOptionFunc(option);
      }
    },

    keyboardShortcuts: _ember['default'].computed(function () {
      var globalState = this.get('keybindings') != false;
      return {
...
define("frontend/pods/components/custom-single-select-content/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "3+1YHTag", "block": "{\"symbols\":[\"option\",\"index\"],\"statements\":[[6,\"div\"],[10,\"class\",[26,[[18,\"dropdownClass\"]]]],[7],[0,\"\\n\"],[4,\"unless\",[[20,[\"hideSearch\"]]],null,{\"statements\":[[0,\"    \"],[6,\"form\"],[9,\"class\",\"input-icon my-3 my-lg-0\"],[7],[0,\"\\n\\n        \"],[1,[25,\"input\",null,[[\"value\",\"class\",\"type\",\"placeholder\"],[[20,[\"query\"]],\"form-control w-100 h-25 mb-2 custom-select-search-box\",\"search\",\"Search...\"]]],false],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"input-icon-addon\"],[7],[0,\"\\n            \"],[6,\"i\"],[9,\"class\",\"fe fe-search\"],[7],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"each\",[[20,[\"filteredOptions\"]]],null,{\"statements\":[[4,\"unless\",[[25,\"eq\",[[20,[\"widgetType\"]],\"boxes\"],null]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[10,\"class\",[26,[[25,\"if\",[[25,\"eq\",[[20,[\"selectedIndex\"]],[19,2,[]]],null],\"custom-select-option-active\"],null],\" \",[25,\"if\",[[25,\"eq\",[[19,2,[]],0],null],\"p-1\",\"p-1 border-top\"],null]]]],[3,\"action\",[[19,0,[]],\"selectOption\",[19,1,[]]]],[7],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-10\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"icon\"]]],null,{\"statements\":[[0,\"                \"],[6,\"i\"],[10,\"class\",[26,[\"fe \",[18,\"icon\"],\" mr-1 text-primary\"]]],[7],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[20,[\"textIcon\"]]],null,{\"statements\":[[0,\"                \"],[6,\"span\"],[9,\"class\",\"text-icon mr-1 bg-primary text-white\"],[7],[1,[18,\"textIcon\"],false],[8],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"                \"],[1,[25,\"get\",[[19,1,[]],[20,[\"displayKey\"]]],null],false],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-2\"],[7],[0,\"\\n\"],[4,\"if\",[[25,\"eq\",[[25,\"get\",[[19,1,[]],[20,[\"displayKey\"]]],null],[25,\"get\",[[20,[\"value\"]],[20,[\"displayKey\"]]],null]],null]],null,{\"statements\":[[0,\"                \"],[6,\"i\"],[9,\"class\",\"fe fe-check text-primary\"],[7],[8],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[6,\"div\"],[10,\"class\",[26,[\"tag mt-1 \",[25,\"if\",[[25,\"eq\",[[20,[\"selectedIndex\"]],[19,2,[]]],null],\"custom-select-option-active\"],null],\"  \",[25,\"if\",[[25,\"eq\",[[25,\"get\",[[19,1,[]],[20,[\"displayKey\"]]],null],[25,\"get\",[[20,[\"value\"]],[20,[\"displayKey\"]]],null]],null],\"bg-indigo-lighter\",\"\"],null]]]],[3,\"action\",[[19,0,[]],\"selectOption\",[19,1,[]]]],[7],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n            \"],[6,\"div\"],[10,\"class\",[26,[\"col-12 \",[19,1,[\"columnClass\"]]]]],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"icon\"]]],null,{\"statements\":[[0,\"                \"],[6,\"i\"],[10,\"class\",[26,[\"fe \",[18,\"icon\"],\" mr-1 text-primary\"]]],[7],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[20,[\"textIcon\"]]],null,{\"statements\":[[0,\"                \"],[6,\"span\"],[9,\"class\",\"text-icon mr-1 bg-primary text-white\"],[7],[1,[18,\"textIcon\"],false],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[20,[\"dynamicIconOnly\"]]],null,{\"statements\":[[0,\"                \"],[6,\"span\"],[9,\"class\",\"\"],[7],[0,\"\\n                    \"],[1,[25,\"component\",[[20,[\"bs\",\"tooltip\"]]],[[\"placement\",\"title\"],[\"top\",[25,\"get\",[[19,1,[]],[20,[\"displayKey\"]]],null]]]],false],[0,\"\\n                    \"],[6,\"i\"],[10,\"class\",[26,[[25,\"get\",[[19,1,[]],[20,[\"iconKey\"]]],null]]]],[7],[8],[0,\"\\n                \"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"                \"],[1,[25,\"get\",[[19,1,[]],[20,[\"displayKey\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]}],[0,\"            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[1,2]},{\"statements\":[[0,\"    \"],[6,\"small\"],[9,\"class\",\"text-muted\"],[7],[0,\"\\n        \"],[1,[18,\"elseMessage\"],false],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]}],[4,\"if\",[[20,[\"helpText\"]]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"p-1\"],[7],[0,\"\\n        \"],[6,\"small\"],[9,\"class\",\"text-muted\"],[7],[0,\"\\n            \"],[1,[18,\"helpText\"],true],[0,\"\\n        \"],[8],[0,\"\\n\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/custom-single-select-content/template.hbs" } });
});
define('frontend/pods/components/custom-single-select/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({});
});
define("frontend/pods/components/custom-single-select/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "i997Dd2b", "block": "{\"symbols\":[\"ddm\"],\"statements\":[[4,\"component\",[[20,[\"dd\",\"menu\"]]],[[\"renderInPlace\"],[false]],{\"statements\":[[1,[25,\"custom-single-select-content\",null,[[\"ddm\",\"dd\",\"dropdownClass\",\"helpText\",\"elseMessage\",\"options\",\"value\",\"icon\",\"textIcon\",\"displayKey\"],[[19,1,[]],[20,[\"dd\"]],[20,[\"dropdownClass\"]],[20,[\"helpText\"]],[20,[\"elseMessage\"]],[20,[\"options\"]],[20,[\"value\"]],[20,[\"icon\"]],[20,[\"textIcon\"]],[20,[\"displayKey\"]]]]],false],[0,\"\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/custom-single-select/template.hbs" } });
});
...
define("frontend/pods/components/database-selector/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "AEhoSvIe", "block": "{\"symbols\":[\"dd\",\"dd\"],\"statements\":[[4,\"if\",[[20,[\"queryObject\",\"database\",\"name\"]]],null,{\"statements\":[[6,\"span\"],[9,\"class\",\"tag border text-primary border-primary  bg-white\"],[7],[0,\"\\n    Data Source:\\n    \"],[6,\"div\"],[9,\"class\",\"tag-addon text-white border-primary bg-primary\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,2,[\"toggle\"]]],[[\"class\"],[\"text-white \"]],{\"statements\":[[0,\"        \"],[1,[20,[\"queryObject\",\"database\",\"name\"]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"        \"],[1,[25,\"custom-single-select\",null,[[\"dd\",\"icon\",\"value\",\"options\",\"displayKey\"],[[19,2,[]],\"fe-database\",[20,[\"queryObject\",\"database\"]],[20,[\"databases\"]],\"name\"]]],false],[0,\"\\n\"]],\"parameters\":[2]},null],[0,\"\\n    \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,1,[\"toggle\"]]],[[\"id\",\"class\"],[\"datasource-selector\",\"btn tag-size  btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\" Data Source\\n\"]],\"parameters\":[]},null],[1,[25,\"custom-single-select\",null,[[\"elseMessage\",\"elseClass\",\"dd\",\"icon\",\"value\",\"options\",\"displayKey\"],[\"You don't have any database. Please ask your admin to add databases or provide you access to already added database\",\"menu-content\",[19,1,[]],\"fe-database\",[20,[\"queryObject\",\"database\"]],[20,[\"databases\"]],\"name\"]]],false],[0,\"\\n\"]],\"parameters\":[1]},null]],\"parameters\":[]}],[0,\"\\n\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/database-selector/template.hbs" } });
});
...
define("frontend/pods/components/db-tree/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "z3EP6PEd", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[9,\"class\",\"db-tree mx-1\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"form-group mb-0\"],[7],[0,\"\\n        \"],[1,[25,\"input\",null,[[\"type\",\"value\",\"class\",\"placeholder\"],[\"text\",[20,[\"query\"]],\"form-control\",\"Search Tables and Columns\"]]],false],[0,\"\\n        \"],[1,[25,\"table-tree\",null,[[\"editor\",\"tables\",\"database\"],[[20,[\"editor\"]],[20,[\"tables\"]],[20,[\"database\"]]]]],false],[0,\"\\n    \"],[8],[0,\"\\n\"],[8]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/db-tree/template.hbs" } });
});
...
define("frontend/pods/components/embeddable-vue-component/component", ["exports", "ember"], function (exports, _ember) {
  exports["default"] = _ember["default"].Component.extend({
    actions: {
...
define("frontend/pods/components/embeddable-vue-component/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "YVoLlrXE", "block": "{\"symbols\":[],\"statements\":[[6,\"iframe\"],[10,\"id\",[18,\"vueIframeID\"],null],[9,\"class\",\"iframe\"],[10,\"src\",[18,\"vueResultPath\"],null],[10,\"onload\",[25,\"action\",[[19,0,[]],\"onLoad\"],null],null],[10,\"style\",[26,[\"width: 100%;  min-height: \",[18,\"minHeight\"],\"px\"]]],[7],[0,\" \"],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/embeddable-vue-component/template.hbs" } });
});
define('frontend/pods/components/filter-maker/component', ['exports', 'ember', 'frontend/mixins/filter-operator-mixin'], function (exports, _ember, _frontendMixinsFilterOperatorMixin) {
  ...
  exports['default'] = _ember['default'].Component.extend(_frontendMixinsFilterOperatorMixin['default'], {
    ...
    availableOperators: _ember['default'].computed('filter.column', function () {
    ...
    operatorObserver: _ember['default'].on('init', _ember['default'].observer('filter.operator', function () {
    ...
    selectDefaultOperator: _ember['default'].observer('filter.column', function () {
      var defaultValue = this.getDefaultValuesforColumn(this.get('filter.column.data_type'));
      var dataType = this.guessDataType(defaultValue);
      var defaultSelectedOperator = null;
      ...
      if (defaultSelectedOperator) {
        var defualtSelectedOperatorObject = this.operators.filter(function (item) {
    ...
    actions: {
      ...
      mutState: function mutState(state) {
...
define("frontend/pods/components/filter-maker/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "c8a5WO5B", "block": "{\"symbols\":[\"ddm\"],\"statements\":[[4,\"component\",[[20,[\"dd\",\"menu\"]]],[[\"renderInPlace\"],[false]],{\"statements\":[[6,\"form\"],[9,\"action\",\"#\"],[9,\"class\",\"\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"menu-content\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"filter\",\"raw\"]]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[9,\"class\",\"switch\"],[3,\"action\",[[19,0,[]],\"switchToBuilder\",\"filters\",[20,[\"filter\"]],false]],[7],[0,\"\\n            \"],[1,[25,\"bs-tooltip\",null,[[\"title\"],[\"Switch To Builder\"]]],false],[0,\"\\n            \"],[6,\"i\"],[9,\"class\",\"fe fe-list text-gray\"],[7],[8],[0,\"\\n        \"],[8],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n            \"],[1,[25,\"input\",null,[[\"value\",\"class\",\"placeholder\"],[[20,[\"filter\",\"value\"]],\"form-control my-2\",\"joining_table.column = 'something'\"]]],false],[0,\"\\n        \"],[8],[0,\"\\n\\n\"],[4,\"if\",[[20,[\"showAddFilter\"]]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[9,\"class\",\"btn btn-primary mt-2 w-100\"],[3,\"action\",[[19,0,[]],\"addNewFilter\"]],[7],[0,\" \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"\\n            Add\\n            Filter \"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"        \"],[6,\"div\"],[9,\"class\",\"btn btn-primary mt-2 w-100\"],[3,\"action\",[[19,0,[]],\"close\"]],[7],[0,\"\\n            Done \"],[8],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[]},{\"statements\":[[0,\"        \"],[6,\"div\"],[9,\"class\",\"switch\"],[3,\"action\",[[19,0,[]],\"switchToRaw\",\"filters\",[20,[\"filter\"]]]],[7],[0,\" \"],[1,[25,\"bs-tooltip\",null,[[\"title\"],[\"Switch To Raw\"]]],false],[0,\"\\n            \"],[6,\"i\"],[9,\"class\",\"fe fe-code text-gray\"],[7],[8],[0,\"\\n        \"],[8],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"row mb-2\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"tag tag-primary\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"filter\",\"column\",\"human_name\"]]],null,{\"statements\":[[0,\"                \"],[6,\"div\"],[9,\"class\",\"\"],[3,\"action\",[[19,0,[]],\"mutState\",1]],[7],[0,\"\\n                    \"],[1,[20,[\"filter\",\"column\",\"human_name\"]],false],[0,\"\\n                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[20,[\"filter\",\"operator\",\"value\"]]],null,{\"statements\":[[0,\"                \"],[6,\"div\"],[9,\"class\",\"tag-addon\"],[3,\"action\",[[19,0,[]],\"mutState\",2]],[7],[0,\"\\n                    \"],[1,[20,[\"filter\",\"operator\",\"value\"]],false],[0,\"\\n                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"unless\",[[25,\"exists-in-array\",[[20,[\"noValueOperators\"]],[20,[\"filter\",\"operator\",\"value\"]]],null]],null,{\"statements\":[[4,\"if\",[[25,\"or\",[[20,[\"filter\",\"value\"]],[25,\"concat\",[[20,[\"filter\",\"valueDateObj\",\"value\"]],[20,[\"filter\",\"valueDateObj\",\"duration\",\"name\"]],[20,[\"filter\",\"valueDateObj\",\"dtt\",\"name\"]]],null]],null]],null,{\"statements\":[[0,\"                \"],[6,\"div\"],[9,\"class\",\"tag-addon\"],[3,\"action\",[[19,0,[]],\"mutState\",3]],[7],[0,\"\\n                    \"],[1,[25,\"or\",[[20,[\"filter\",\"value\"]],[25,\"concat\",[[20,[\"filter\",\"valueDateObj\",\"value\"]],\" \",[20,[\"filter\",\"valueDateObj\",\"duration\",\"name\"]],\" \",[20,[\"filter\",\"valueDateObj\",\"dtt\",\"name\"]]],null]],null],false],[0,\"\\n                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[0,\"            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"],[4,\"if\",[[25,\"eq\",[[20,[\"state\"]],1],null]],null,{\"statements\":[[0,\"        \"],[1,[25,\"custom-single-select-content\",null,[[\"selectCallbackAction\",\"dropdownClass\",\"elseMessage\",\"options\",\"value\",\"textIcon\",\"displayKey\"],[[25,\"action\",[[19,0,[]],\"mutState\",3],null],\"menu-content\",\"No columns were found in the selected table\",[20,[\"columns\"]],[20,[\"filter\",\"column\"]],\"C\",\"name\"]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"if\",[[25,\"eq\",[[20,[\"state\"]],2],null]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[9,\"class\",\"card-footer px-0\"],[7],[0,\"\\n\"],[4,\"if\",[[25,\"is-empty\",[[20,[\"availableOperators\"]]],null]],null,{\"statements\":[[0,\"            \"],[6,\"div\"],[9,\"class\",\"my-2\"],[7],[0,\"\\n                \"],[6,\"small\"],[9,\"class\",\"text-muted \"],[7],[0,\"Filtering is not available for \"],[1,[20,[\"filter\",\"column\",\"data_type\"]],false],[0,\" data type\\n                \"],[8],[0,\"\\n\\n            \"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"            \"],[1,[25,\"custom-single-select-content\",null,[[\"selectCallbackAction\",\"dropdownClass\",\"elseMessage\",\"options\",\"value\",\"hideSearch\",\"widgetType\",\"displayKey\"],[[25,\"action\",[[19,0,[]],\"mutState\",3],null],\"menu-content mb-2\",\"Comparator is not supported\",[20,[\"availableOperators\"]],[20,[\"filter\",\"operator\"]],true,\"boxes\",\"value\"]]],false],[0,\"\\n\"]],\"parameters\":[]}],[0,\"\\n        \"],[8],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"border-top\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n                \"],[6,\"div\"],[9,\"class\",\"col-6\"],[7],[0,\"\\n                    \"],[6,\"button\"],[9,\"class\",\"btn btn-link mt-2\"],[3,\"action\",[[19,0,[]],\"mutState\",1]],[7],[0,\"Go Back\"],[8],[0,\"\\n                \"],[8],[0,\"\\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,\"eq\",[[20,[\"state\"]],3],null]],null,{\"statements\":[[4,\"unless\",[[25,\"exists-in-array\",[[20,[\"noValueOperators\"]],[20,[\"filter\",\"operator\",\"value\"]]],null]],null,{\"statements\":[[0,\"        \"],[1,[25,\"filter-value-selector\",null,[[\"results\",\"filter\",\"showDatePicker\"],[[20,[\"results\"]],[20,[\"filter\"]],[20,[\"showDatePicker\"]]]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"border-top\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n                \"],[6,\"div\"],[9,\"class\",\"col-6\"],[7],[0,\"\\n                    \"],[6,\"button\"],[9,\"class\",\"btn btn-link mt-2\"],[3,\"action\",[[19,0,[]],\"mutState\",2]],[7],[0,\"Go Back\"],[8],[0,\"\\n                \"],[8],[0,\"\\n                \"],[6,\"div\"],[9,\"class\",\"col-6\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"showAddFilter\"]]],null,{\"statements\":[[0,\"                    \"],[6,\"div\"],[9,\"class\",\"btn btn-primary mt-2 w-100\"],[3,\"action\",[[19,0,[]],\"addNewFilter\"]],[7],[0,\" \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"\\n                        Add\\n                        Filter \"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"                    \"],[6,\"div\"],[9,\"class\",\"btn btn-primary mt-2 w-100\"],[3,\"action\",[[19,0,[]],\"close\"]],[7],[0,\"\\n                        Done \"],[8],[0,\"\\n\"]],\"parameters\":[]}],[0,\"\\n                \"],[8],[0,\"\\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]}],[0,\"\\n    \"],[8],[0,\"\\n\\n\"],[8],[0,\"\\n\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/filter-maker/template.hbs" } });
});
define('frontend/pods/components/filter-value-selector/component', ['exports', 'ember', 'frontend/mixins/helper-mixin'], function (exports, _ember, _frontendMixinsHelperMixin) {
  exports['default'] = _ember['default'].Component.extend(_frontendMixinsHelperMixin['default'], {
    ...
    setAllOtherFalse: function setAllOtherFalse(_this) {
      _this.get('sortedColumnValues') && _this.get('sortedColumnValues').forEach(function (item) {
        item.set('selected', false);
      }) || [];
    },

    shouldGetColumnSuggestions: function shouldGetColumnSuggestions(column) {
      var columnDataType = column && (column.get && column.get('data_type') || column.data_type);
      return columnDataType && (columnDataType.match('char') || columnDataType.match('string'));
    },

    suggestionsObserver: _ember['default'].on('init', _ember['default'].observer('filter.column', 'filter.value', function () {
      var _this2 = this;
      ...
      if (this.get('filter.column.id')) {
        if (this.get('filter.value') && this.get('filter.value') != '' && this.shouldGetColumnSuggestions(this.get('filter.column'))) {
          this.get('ajax').apiCall({
            url: this.get('ajax.apiPath') + '/column_suggestions_autocomplete' + '&query=' + this.get('filter.value') + '&column_id=' + this.get('filter.column.id'),
            type: 'GET'
          }, function (response, status) {
            _this2.set('suggestions', response);
          }, function (error, status) {});
        } else {
    ...
    findLocalSuggestionsForColumn: function findLocalSuggestionsForColumn(columnName, query) {
      var _this3 = this;
      ...
      if (columns && rows) {
        var _ret = (function () {
          ...
          var suggestions = rows.filter(function (item) {
            if (query) {
          ...
          return {
            v: _this3.uniqueByProperty(suggestions, 'displayName').sort(function (a, b) {
    ...
    actions: {
      mutFilterValue: function mutFilterValue(value) {
...
define("frontend/pods/components/filter-value-selector/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "pvYK5IcJ", "block": "{\"symbols\":[\"suggestion\",\"tab\"],\"statements\":[[4,\"if\",[[20,[\"showDatePicker\"]]],null,{\"statements\":[[4,\"bs-tab\",null,null,{\"statements\":[[4,\"component\",[[19,2,[\"pane\"]]],[[\"title\"],[\"Duration\"]],{\"statements\":[[1,[25,\"input\",null,[[\"value\",\"class\",\"placeholder\"],[[20,[\"filter\",\"valueDateObj\",\"value\"]],\"form-control my-2\",\"30\"]]],false],[0,\"\\n\\n\"],[6,\"div\"],[9,\"class\",\"border-top py-2\"],[7],[0,\"\\n  \"],[1,[25,\"custom-single-select-content\",null,[[\"hideSearch\",\"widgetType\",\"options\",\"value\",\"displayKey\"],[true,\"boxes\",[20,[\"durations\"]],[20,[\"filter\",\"valueDateObj\",\"duration\"]],\"name\"]]],false],[0,\"\\n\\n\"],[8],[0,\"\\n\"],[6,\"div\"],[9,\"class\",\"border-top py-2\"],[7],[0,\"\\n  \"],[1,[25,\"custom-single-select-content\",null,[[\"hideSearch\",\"widgetType\",\"options\",\"value\",\"displayKey\"],[true,\"boxes\",[20,[\"dateTimeTypes\"]],[20,[\"filter\",\"valueDateObj\",\"dtt\"]],\"name\"]]],false],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[19,2,[\"pane\"]]],[[\"title\"],[\"Datepicker\"]],{\"statements\":[[0,\"\\n\"],[1,[25,\"bs-datetimepicker\",null,[[\"class\",\"date\",\"inline\",\"useCurrent\"],[\"d-block\",[20,[\"filter\",\"value\"]],true,\"day\"]]],false],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[2]},null]],\"parameters\":[]},{\"statements\":[[1,[25,\"input\",null,[[\"class\",\"value\",\"class\",\"placeholder\"],[\"form-control my-2\",[20,[\"filter\",\"value\"]],\"ui\",\"Column Value\"]]],false],[0,\"\\n\"],[4,\"each\",[[20,[\"suggestions\"]]],null,{\"statements\":[[6,\"div\"],[9,\"class\",\"border-bottom py-2 text-primary\"],[3,\"action\",[[19,0,[]],[25,\"mut\",[[20,[\"filter\",\"value\"]]],null],[19,1,[\"displayName\"]]]],[7],[0,\"\\n  \"],[1,[25,\"format-object\",[[19,1,[\"displayName\"]]],null],false],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[1]},null]],\"parameters\":[]}]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/filter-value-selector/template.hbs" } });
});
...
define("frontend/pods/components/funnel-chart-settings/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "ABkSN6Nv", "block": "{\"symbols\":[],\"statements\":[[1,[25,\"base-chart-settings\",null,[[\"resultsViewSettings\",\"results\",\"defaultChartType\",\"barType\"],[[20,[\"resultsViewSettings\"]],[20,[\"results\"]],[20,[\"defaultChartType\"]],[20,[\"barType\"]]]]],false]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/funnel-chart-settings/template.hbs" } });
});
...
define("frontend/pods/components/group-by-maker/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "F9MdvdQ4", "block": "{\"symbols\":[\"ddm\"],\"statements\":[[4,\"component\",[[20,[\"dd\",\"menu\"]]],[[\"renderInPlace\"],[false]],{\"statements\":[[6,\"div\"],[9,\"class\",\"menu-content\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"groupBy\",\"selected\",\"raw\"]]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"switch\"],[3,\"action\",[[19,0,[]],\"switchToBuilder\",\"groupBys\",[20,[\"groupBy\"]],true]],[7],[0,\" \"],[1,[25,\"bs-tooltip\",null,[[\"title\"],[\"Switch To Builder\"]]],false],[0,\"\\n        \"],[6,\"i\"],[9,\"class\",\"fe fe-list text-gray\"],[7],[8],[0,\"\\n    \"],[8],[0,\"\\n    \"],[1,[25,\"input\",null,[[\"value\",\"class\",\"placeholder\"],[[20,[\"groupBy\",\"selected\",\"value\"]],\"form-control my-2\",\"Something complex\"]]],false],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"switch\"],[3,\"action\",[[19,0,[]],\"switchToRaw\",\"groupBys\",[20,[\"groupBy\"]],true]],[7],[0,\" \"],[1,[25,\"bs-tooltip\",null,[[\"title\"],[\"Switch To Raw\"]]],false],[0,\"\\n        \"],[6,\"i\"],[9,\"class\",\"fe fe-code text-gray\"],[7],[8],[0,\"\\n    \"],[8],[0,\"\\n\"],[4,\"if\",[[25,\"eq\",[[20,[\"state\"]],1],null]],null,{\"statements\":[[0,\"    \"],[1,[25,\"custom-single-select-content\",null,[[\"elseMessage\",\"options\",\"value\",\"selectCallbackAction\",\"helpText\",\"displayKey\"],[\"Column does not exist.\",[20,[\"columns\"]],[20,[\"groupBy\",\"selected\"]],\"selectedColumn\",\"Aggregates like count, average etc. are required to view meaningful data when adding a\\n    grouping. So don't forget to add a view. \",\"human_name\"]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\\n\"],[4,\"if\",[[25,\"eq\",[[20,[\"state\"]],2],null]],null,{\"statements\":[[4,\"if\",[[20,[\"isGroupByDateType\"]]],null,{\"statements\":[[0,\"    \"],[1,[25,\"custom-single-select-content\",null,[[\"elseMessage\",\"selectCallbackAction\",\"options\",\"value\",\"hideSearch\",\"helpText\",\"displayKey\"],[\"No Such View is supported. Use Raw for complex views\",\"addNewGroupBy\",[20,[\"groupByDateTypes\"]],[20,[\"groupBy\",\"castType\"]],true,\"Aggregates like count, average etc. are required to view meaningful data when adding a\\n    grouping. So don't forget to add a view. \",\"name\"]]],false],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null]],\"parameters\":[]}],[0,\"\\n\\n\"],[8],[0,\"\\n\"],[4,\"if\",[[20,[\"showAddGroupBy\"]]],null,{\"statements\":[[6,\"div\"],[9,\"class\",\"btn btn-primary mt-2 w-100\"],[3,\"action\",[[19,0,[]],\"addNewGroupBy\"]],[7],[0,\" \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"\\n    Add\\n    Grouping\"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[6,\"div\"],[9,\"class\",\"btn btn-primary mt-2 w-100\"],[3,\"action\",[[19,0,[]],\"close\"]],[7],[0,\"\\n    done\"],[8],[0,\"\\n\\n\"]],\"parameters\":[]}]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/group-by-maker/template.hbs" } });
});
...
define("frontend/pods/components/limited-query-accordian/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "tTy9gZOx", "block": "{\"symbols\":[\"acc\",\"aitem\"],\"statements\":[[4,\"bs-accordion\",null,[[\"class\"],[\"text-default mb-1\"]],{\"statements\":[[4,\"component\",[[19,1,[\"item\"]]],[[\"class\"],[\"m-0 w-100\"]],{\"statements\":[[6,\"div\"],[9,\"class\",\"card-status card-status-left bg-warning\"],[7],[8],[0,\"\\n\"],[4,\"component\",[[19,2,[\"title\"]]],[[\"class\"],[\"py-2\"]],{\"statements\":[[6,\"i\"],[9,\"class\",\"fe fe-chevron-down\"],[7],[8],[0,\"\\nLimit has been set on this query. This happens when you try to load more than \"],[1,[18,\"queryLimit\"],false],[0,\" rows. You can still\\ndownload complete data.\\n\"]],\"parameters\":[]},null],[4,\"component\",[[19,2,[\"body\"]]],null,{\"statements\":[[1,[25,\"ember-ace\",null,[[\"lines\",\"value\",\"mode\",\"theme\",\"readOnly\"],[10,[20,[\"limitedQuery\"]],[20,[\"aceMode\"]],[20,[\"aceTheme\"]],true]]],false],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[2]},null]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/limited-query-accordian/template.hbs" } });
});
...
define("frontend/pods/components/number-chart/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "+l6+p+sx", "block": "{\"symbols\":[\"number\",\"number\"],\"statements\":[[6,\"div\"],[9,\"class\",\"full text-align-center h-100\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"row h-100\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"onlyOne\"]]],null,{\"statements\":[[4,\"each\",[[20,[\"numbers\"]]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[9,\"class\",\"col-12 text-center my-auto\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"h1 m-0 mt-4\"],[7],[0,\"\\n                \"],[1,[25,\"localize\",[[19,2,[\"value\"]]],null],false],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"small\"],[9,\"class\",\"text-muted mb-4\"],[7],[0,\"\\n                \"],[1,[25,\"capitalize\",[[19,2,[\"title\"]]],null],false],[0,\"\\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[2]},null]],\"parameters\":[]},{\"statements\":[[4,\"each\",[[20,[\"numbers\"]]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[9,\"class\",\"col-3 my-auto\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"text-align-center \"],[7],[0,\"\\n                \"],[6,\"div\"],[9,\"class\",\"h1 m-0\"],[7],[0,\"\\n                    \"],[1,[25,\"localize\",[[19,1,[\"value\"]]],null],false],[0,\"\\n                \"],[8],[0,\"\\n                \"],[6,\"small\"],[9,\"class\",\"text-muted mb-4\"],[7],[0,\"\\n                    \"],[1,[25,\"capitalize\",[[19,1,[\"title\"]]],null],false],[0,\"\\n                \"],[8],[0,\"\\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[1]},null]],\"parameters\":[]}],[0,\"    \"],[8],[0,\"\\n\"],[8]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/number-chart/template.hbs" } });
});
define('frontend/pods/components/order-by-maker/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    actions: {
      ...
      focusOnOrderSelect: function focusOnOrderSelect() {
        this.set('state', 2);
      },
      close: function close() {
        $('body').trigger('click');
...
define("frontend/pods/components/order-by-maker/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "ULXUUlru", "block": "{\"symbols\":[\"ddm\"],\"statements\":[[4,\"component\",[[20,[\"dd\",\"menu\"]]],[[\"renderInPlace\"],[false]],{\"statements\":[[6,\"div\"],[9,\"class\",\"menu-content\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"tags border-bottom mb-2\"],[7],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"tag tag-primary\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"orderBy\",\"column\",\"name\"]]],null,{\"statements\":[[0,\"            \"],[6,\"div\"],[3,\"action\",[[19,0,[]],\"mutState\",1]],[7],[0,\"\\n\\n                \"],[1,[20,[\"orderBy\",\"column\",\"name\"]],false],[0,\"\\n            \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[20,[\"orderBy\",\"order\",\"name\"]]],null,{\"statements\":[[0,\"            \"],[6,\"div\"],[9,\"class\",\"tag-addon\"],[3,\"action\",[[19,0,[]],\"mutState\",2]],[7],[0,\"\\n                \"],[1,[20,[\"orderBy\",\"order\",\"name\"]],false],[0,\"\\n            \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"],[4,\"if\",[[25,\"eq\",[[20,[\"state\"]],1],null]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"menu-content\"],[7],[0,\"\\n        \"],[1,[25,\"custom-single-select-content\",null,[[\"selectCallbackAction\",\"elseMessage\",\"options\",\"value\",\"displayKey\"],[\"focusOnOrderSelect\",\"No such column\",[20,[\"filteredColumns\"]],[20,[\"orderBy\",\"column\"]],\"human_name\"]]],false],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,\"eq\",[[20,[\"state\"]],2],null]],null,{\"statements\":[[0,\"    \"],[1,[25,\"custom-single-select-content\",null,[[\"hideSearch\",\"widgetType\",\"dd\",\"ddm\",\"selectCallbackAction\",\"dropdownClass\",\"options\",\"value\",\"displayKey\"],[true,\"boxes\",[20,[\"dd\"]],[19,1,[]],\"addNewOrderBy\",\"js-order-by-order-select\",[20,[\"orders\"]],[20,[\"orderBy\",\"order\"]],\"name\"]]],false],[0,\"\\n\\n\\n    \"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"col-6\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"btn btn-link mt-2 w-100 text-left\"],[3,\"action\",[[19,0,[]],\"mutState\",1]],[7],[0,\" Go Back\"],[8],[0,\"\\n        \"],[8],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"col-6\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"showAddOrderBy\"]]],null,{\"statements\":[[0,\"            \"],[6,\"div\"],[9,\"class\",\"btn btn-primary mt-2 w-100\"],[3,\"action\",[[19,0,[]],\"addNewOrderBy\"]],[7],[0,\" \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"\\n                Add\\n                Sort Order\"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"btn btn-primary mt-2 w-100\"],[3,\"action\",[[19,0,[]],\"close\"]],[7],[0,\" \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"\\n                Done\"],[8],[0,\"\\n\"]],\"parameters\":[]}],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/order-by-maker/template.hbs" } });
});
...
define('frontend/pods/components/query-builder/component', ['exports', 'ember', 'ember-keyboard-shortcuts/mixins/component'], function (exports, _ember, _emberKeyboardShortcutsMixinsComponent) {
  exports['default'] = _ember['default'].Component.extend(_emberKeyboardShortcutsMixinsComponent['default'], {
    ...
    databaseObserver: _ember['default'].on('init', _ember['default'].observer('queryObject.database', function () {
      var database = this.get('queryObject.database');
    ...
    actions: {
      ...
      toggleSql: function toggleSql() {
        var databaseType = this.get('queryObject.database.db_type');
        if (databaseType == 'api_client') {
          var existingApiAction = this.get('apiAction');
          if (!existingApiAction) {
            var apiAction = this.get('store').createRecord('apiAction', {
              color: 'indigo',
              method: 'GET',
              headers: [],
              response_settings: _ember['default'].Object.create(),
      ...
      transitionToQuestion: function transitionToQuestion(id) {
...
define("frontend/pods/components/query-builder/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "INK52JSh", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[9,\"class\",\"card\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"card-footer border-top-0\"],[7],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-11\"],[7],[0,\"\\n\\n                \"],[1,[25,\"database-selector\",null,[[\"queryObject\",\"toggleSql\",\"databases\",\"acc\"],[[20,[\"queryObject\"]],\"toggleSql\",[20,[\"databases\"]],[20,[\"acc\"]]]]],false],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"col-1 text-right p-1\"],[7],[0,\"\\n                \"],[6,\"span\"],[9,\"class\",\"right\"],[9,\"data-tooltip\",\"Switch to SQL\"],[9,\"data-inverted\",\"\"],[9,\"data-variation\",\"inverted\"],[3,\"action\",[[19,0,[]],\"toggleSql\"]],[7],[6,\"i\"],[9,\"class\",\"fe fe-terminal\"],[7],[8],[8],[0,\"\\n            \"],[8],[0,\"\\n\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\\n    \"],[1,[25,\"subquery-builder\",null,[[\"queryObject\",\"databases\",\"acc\"],[[20,[\"queryObject\"]],[20,[\"databases\"]],[20,[\"acc\"]]]]],false],[0,\"\\n\"],[4,\"if\",[[20,[\"showGetResults\"]]],null,{\"statements\":[[4,\"if\",[[20,[\"loading\"]]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"content active\"],[7],[0,\"\\n        \"],[6,\"button\"],[9,\"class\",\"btn btn-secondary full rounded-0\"],[7],[0,\" Crunching Data ... \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"content active\"],[9,\"id\",\"ag_get_results\"],[7],[0,\"\\n        \"],[6,\"button\"],[9,\"class\",\"btn btn-primary full rounded-0\"],[3,\"action\",[[19,0,[]],\"getResults\"]],[7],[0,\" Get Results \"],[6,\"i\"],[9,\"class\",\"fe fe-arrow-right\"],[7],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[]},null],[8],[0,\"\\n\\n\"],[1,[25,\"api-action-modal\",null,[[\"hideSaveButton\",\"apiAction\",\"open\",\"openPreview\",\"results\",\"question\",\"columnReplacable\",\"resultViewPossibleKeys\",\"hideName\"],[true,[20,[\"apiAction\"]],[20,[\"toggleApiActionModal\"]],[20,[\"openPreview\"]],[20,[\"results\"]],[20,[\"question\"]],false,[20,[\"resultViewPossibleKeys\"]],true]]],false],[0,\"\\n\"],[1,[25,\"api-action-result\",null,[[\"transitionToQuestion\",\"canDebug\",\"result\",\"open\",\"apiAction\",\"question\",\"resultViewPossibleKeys\"],[\"transitionToQuestion\",true,[20,[\"results\"]],[20,[\"openPreview\"]],[20,[\"apiAction\"]],[20,[\"question\"]],[20,[\"resultViewPossibleKeys\"]]]]],false],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/query-builder/template.hbs" } });
});
...
define("frontend/pods/components/question-widget/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "AMexHNgg", "block": "{\"symbols\":[\"dd\",\"ddm\"],\"statements\":[[4,\"if\",[[25,\"not\",[[20,[\"hideMenu\"]]],null]],null,{\"statements\":[[4,\"if\",[[20,[\"question\",\"updated_at\"]]],null,{\"statements\":[[6,\"span\"],[9,\"class\",\"card-body-timer\"],[7],[0,\"\\n    \"],[4,\"bs-tooltip\",null,[[\"placement\"],[\"left\"]],{\"statements\":[[0,\" Updated \"],[1,[25,\"moment-from-now\",[[20,[\"question\",\"updated_at\"]]],[[\"timeZone\",\"interval\"],[[20,[\"timeZone\"]],1000]]],false],[0,\"\\\"\\n\"]],\"parameters\":[]},null],[0,\"    \"],[6,\"i\"],[10,\"class\",[26,[\"fe fe-clock text-\",[20,[\"question\",\"updatedAgoColor\"]]]]],[7],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"bs-dropdown\",null,[[\"direction\",\"class\"],[\"left\",\"card-body-menu\"]],{\"statements\":[[4,\"component\",[[19,1,[\"toggle\"]]],[[\"class\"],[\"\"]],{\"statements\":[[6,\"i\"],[9,\"class\",\"fe fe-more-vertical text-gray\"],[7],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[19,1,[\"menu\"]]],[[\"class\"],[\"dropdown-menu-arrow\"]],{\"statements\":[[6,\"div\"],[9,\"class\",\"menu-content\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"question\",\"has_permission\"]]],null,{\"statements\":[[4,\"component\",[[19,2,[\"item\"]]],null,{\"statements\":[[0,\"    \"],[4,\"link-to\",[\"questions.show\",[20,[\"question\",\"id\"]]],[[\"class\"],[\"dropdown-item\"]],{\"statements\":[[0,\" View Question \"]],\"parameters\":[]},null],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[4,\"component\",[[19,2,[\"item\"]]],null,{\"statements\":[[0,\"    \"],[6,\"a\"],[9,\"class\",\"dropdown-item\"],[3,\"action\",[[19,0,[]],\"refresh\"]],[7],[0,\" Refresh \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,\"and\",[[20,[\"dashboard\",\"has_permission\"]],[25,\"can\",[\"edit dashboard\"],null]],null]],null,{\"statements\":[[4,\"component\",[[19,2,[\"item\"]]],null,{\"statements\":[[0,\"    \"],[6,\"a\"],[9,\"class\",\"dropdown-item\"],[3,\"action\",[[19,0,[]],\"remove\"]],[7],[0,\" Remove from Dashboard \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[2]},null]],\"parameters\":[1]},null]],\"parameters\":[]},null],[6,\"div\"],[10,\"class\",[26,[\"renderer-component \",[18,\"fullscreenClass\"],\" h-100\"]]],[7],[0,\"\\n    \"],[1,[25,\"component\",[[20,[\"resultsWidgetComponent\"]]],[[\"canEdit\",\"results\",\"resultsViewSettings\",\"resultsViewType\",\"questionName\",\"question\",\"context\",\"setState\",\"colorway\",\"resizeTime\",\"apply\",\"showQuickFilters\"],[[25,\"can\",[\"edit question\"],null],[20,[\"results\"]],[20,[\"resultsViewSettings\"]],[20,[\"resultsViewType\"]],[20,[\"questionName\"]],[20,[\"question\"]],[20,[\"componentContext\"]],[20,[\"setState\"]],[20,[\"colorway\"]],[20,[\"resizeTime\"]],[20,[\"apply\"]],[20,[\"showQuickFilters\"]]]]],false],[0,\"\\n\"],[8]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/question-widget/template.hbs" } });
});
...
define('frontend/pods/components/results-table-settings/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    columns: _ember['default'].computed('results.columns', function () {
      return this.get('results.columns') && this.get('results.columns').map(function (item) {
        return { title: item };
      });
    }),
    selectedHiddenColumns: _ember['default'].computed('resultsViewSettings.hiddenColumns.[]', function () {
      return this.get('resultsViewSettings.hiddenColumns') && this.get('resultsViewSettings.hiddenColumns').map(function (item) {
        return { title: item };
      });
    }),

    actions: {
      mutateHiddenColumns: function mutateHiddenColumns(columns) {
        this.set('resultsViewSettings.hiddenColumns', columns && columns.map(function (item) {
          return item.title;
        }));
      }
    }
...
define("frontend/pods/components/results-table-settings/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "UGEskUrz", "block": "{\"symbols\":[],\"statements\":[[4,\"if\",[[20,[\"canEdit\"]]],null,{\"statements\":[[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"col-6\"],[7],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n            \"],[6,\"label\"],[9,\"for\",\"\"],[9,\"class\",\"form-label\"],[7],[0,\"\\n                Hidden Columns\\n            \"],[8],[0,\"\\n            \"],[1,[25,\"searchable-select\",null,[[\"content\",\"selected\",\"closeOnSelection\",\"multiple\",\"prompt\",\"on-change\"],[[20,[\"columns\"]],[20,[\"selectedHiddenColumns\"]],true,true,\"Select columns\",[25,\"action\",[[19,0,[]],\"mutateHiddenColumns\"],null]]]],false],[0,\"\\n        \"],[8],[0,\"\\n\\n    \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/results-table-settings/template.hbs" } });
});
...
define('frontend/pods/components/search-box/component', ['exports', 'ember', 'ember-keyboard-shortcuts/mixins/component'], function (exports, _ember, _emberKeyboardShortcutsMixinsComponent) {
  exports['default'] = _ember['default'].Component.extend(_emberKeyboardShortcutsMixinsComponent['default'], {
    ...
    searcheditemsObserver: _ember['default'].on('init', _ember['default'].observer('query', "items.isFulfilled", function () {
      _ember['default'].run.debounce(this, this.setFilteredItems, 300);
    })),
    setFilteredItems: function setFilteredItems() {
      this.set('selectedIndex', 0);
    ...
    actions: {
      ...
      goToQuestionClick: function goToQuestionClick(item) {
        this.sendAction('goToQuestion', item);
      },
      goToDashboardClick: function goToDashboardClick(item) {
        this.sendAction('goToDashboard', item);
      },
      goToTagClick: function goToTagClick(item) {
        this.sendAction('goToTag', item);
      },
      goToItem: function goToItem() {
        var item = this.get('filteredItems').objectAt(this.get('selectedIndex'));
...
define("frontend/pods/components/search-box/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "KKR5W/8w", "block": "{\"symbols\":[\"item\",\"index\"],\"statements\":[[6,\"div\"],[9,\"class\",\"searchbar overlay\"],[7],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"dashboard-selector searchbar-content\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"create-dashboard content\"],[7],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"ui vertical menu full\"],[7],[0,\"\\n\\n        \"],[6,\"div\"],[9,\"class\",\"item\"],[7],[0,\"\\n          \"],[6,\"div\"],[9,\"class\",\"ui icon input\"],[7],[0,\"\\n            \"],[6,\"i\"],[9,\"class\",\"search icon\"],[7],[8],[0,\"\\n            \"],[1,[25,\"input\",null,[[\"type\",\"placeholder\",\"class\",\"value\"],[\"text\",\"Search Question, Dashboard or Tag\",\"item-selector-input\",[20,[\"query\"]]]]],false],[0,\"\\n          \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"],[4,\"each\",[[20,[\"filteredItems\"]]],null,{\"statements\":[[4,\"if\",[[25,\"eq\",[[19,1,[\"item_type\"]],\"question\"],null]],null,{\"statements\":[[4,\"if\",[[19,1,[\"id\"]]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[10,\"class\",[26,[\"item \",[25,\"if\",[[25,\"eq\",[[20,[\"selectedIndex\"]],[19,2,[]]],null],\"active\"],null]]]],[3,\"action\",[[19,0,[]],\"goToQuestionClick\",[19,1,[]]]],[7],[0,\"\\n          \"],[6,\"div\"],[9,\"class\",\"d-flex align-items-center\"],[7],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"avatar mr-2 text-white bg-primary\"],[7],[0,\"\\n              \"],[6,\"b\"],[9,\"class\",\"text-white\"],[7],[0,\"Q\"],[8],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[7],[0,\"\\n              \"],[6,\"h6\"],[9,\"class\",\"m-0 text-default\"],[7],[0,\" \"],[1,[19,1,[\"title\"]],false],[0,\" \"],[8],[0,\"\\n              \"],[6,\"small\"],[9,\"class\",\"text-muted\"],[7],[0,\" Question\"],[8],[0,\"\\n            \"],[8],[0,\"\\n          \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[4,\"if\",[[25,\"eq\",[[19,1,[\"item_type\"]],\"dashboard\"],null]],null,{\"statements\":[[4,\"if\",[[19,1,[\"id\"]]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[10,\"class\",[26,[\"item \",[25,\"if\",[[25,\"eq\",[[20,[\"selectedIndex\"]],[19,2,[]]],null],\"active\"],null]]]],[3,\"action\",[[19,0,[]],\"goToDashboardClick\",[19,1,[]]]],[7],[0,\"\\n          \"],[6,\"div\"],[9,\"class\",\"d-flex align-items-center\"],[7],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"avatar mr-2 text-white bg-primary\"],[7],[0,\"\\n              \"],[6,\"b\"],[9,\"class\",\"text-white\"],[7],[0,\"D\"],[8],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[7],[0,\"\\n              \"],[6,\"h6\"],[9,\"class\",\"m-0 text-default\"],[7],[0,\" \"],[1,[19,1,[\"title\"]],false],[0,\" \"],[8],[0,\"\\n              \"],[6,\"small\"],[9,\"class\",\"text-muted\"],[7],[0,\" Dashboard\"],[8],[0,\"\\n            \"],[8],[0,\"\\n          \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[4,\"if\",[[25,\"eq\",[[19,1,[\"item_type\"]],\"tag\"],null]],null,{\"statements\":[[4,\"if\",[[19,1,[\"id\"]]],null,{\"statements\":[[0,\"        \"],[6,\"div\"],[10,\"class\",[26,[\"item \",[25,\"if\",[[25,\"eq\",[[20,[\"selectedIndex\"]],[19,2,[]]],null],\"active\"],null]]]],[3,\"action\",[[19,0,[]],\"goToTagClick\",[19,1,[]]]],[7],[0,\"\\n          \"],[6,\"div\"],[9,\"class\",\"d-flex align-items-center\"],[7],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"avatar mr-2 text-white bg-primary\"],[7],[0,\"\\n              \"],[6,\"b\"],[9,\"class\",\"text-white\"],[7],[0,\"T\"],[8],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[7],[0,\"\\n              \"],[6,\"h6\"],[9,\"class\",\"m-0 text-default\"],[7],[0,\" \"],[1,[19,1,[\"title\"]],false],[0,\" \"],[8],[0,\"\\n              \"],[6,\"small\"],[9,\"class\",\"text-muted\"],[7],[0,\" Tag\"],[8],[0,\"\\n            \"],[8],[0,\"\\n          \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null]],\"parameters\":[1,2]},{\"statements\":[[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"item\"],[7],[0,\"\\n          No Results\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]}],[0,\"        \"],[6,\"div\"],[9,\"class\",\"item px-4 py-2 bg-gray\"],[7],[0,\"\\n          \"],[6,\"small\"],[9,\"class\",\"text-white\"],[7],[0,\"Press 'Ctrl + Q' from anywhere to open this dialogue. Press 'Esc' to exit.\"],[8],[0,\"\\n        \"],[8],[0,\"\\n      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n\"],[8]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/search-box/template.hbs" } });
});
...
define('frontend/pods/components/snapshot-creator/component', ['exports', 'ember'], function (exports, _ember) {
    exports['default'] = _ember['default'].Component.extend({
        ...
        snapshot: _ember['default'].computed("startTime", function () {
            return {
...
define('frontend/pods/components/subquery-builder/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    canShowTableWidget: _ember['default'].computed('queryObject.database.name', function () {
      var databaseType = this.get('queryObject.database.db_type');
      return databaseType && databaseType != 'api_client' && !!this.get('queryObject.database.name');
    }),
    canShowFilters: _ember['default'].computed('queryObject.database.name', 'queryObject.table.human_name', 'queryObject.table.title', function () {
    ...
    newFilter: _ember['default'].computed('queryObject.filters.[]', function () {
      return _ember['default'].Object.create({
        column: null,
        operator: null,
        value: null,
    ...
    newView: _ember['default'].computed('queryObject.views.[]', function () {
      return this.get('rawObject').create();
    }),
    newGroupBy: _ember['default'].computed('queryObject.groupBys.[]', function () {
      return this.get('rawObjectWithSelected')(this);
    }),
    newOrderBy: _ember['default'].computed('queryObject.orderBys.[]', function () {
      return this.get('rawObjectWithSelected')(this);
    }),
    actions: {
      addNewFilter: function addNewFilter() {
      ...
      remove: function remove(type, el) {
        var arr = _ember['default'].Object.create(this.get('queryObject')).get(type);
        arr.removeObject(el);
      },
...
define("frontend/pods/components/subquery-builder/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "p/TAdDZt", "block": "{\"symbols\":[\"dd\",\"orderBy\",\"dd\",\"dd\",\"groupBy\",\"dd\",\"dd\",\"selectView\",\"dd\",\"dd\",\"filter\",\"dd\",\"dd\",\"dd\"],\"statements\":[[4,\"if\",[[20,[\"canShowTableWidget\"]]],null,{\"statements\":[[6,\"div\"],[9,\"class\",\"card-footer row\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"col-11\"],[7],[0,\"\\n\"],[4,\"if\",[[25,\"or\",[[20,[\"queryObject\",\"table\",\"name\"]],[20,[\"queryObject\",\"table\",\"title\"]]],null]],null,{\"statements\":[[0,\"        \"],[6,\"span\"],[9,\"class\",\"tag border text-primary border-primary  bg-white mt-1\"],[7],[0,\"\\n            \"],[4,\"if\",[[20,[\"queryObject\",\"fromQuestion\"]]],null,{\"statements\":[[0,\"Question: \"]],\"parameters\":[]},{\"statements\":[[0,\"Table: \"]],\"parameters\":[]}],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"tag-addon text-white border-primary bg-primary\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,14,[\"toggle\"]]],[[\"class\"],[\"text-white menu-content\"]],{\"statements\":[[0,\"                \"],[1,[25,\"or\",[[20,[\"queryObject\",\"table\",\"human_name\"]],[20,[\"queryObject\",\"table\",\"title\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[20,[\"queryObject\",\"fromQuestion\"]]],null,{\"statements\":[[0,\"                \"],[1,[25,\"custom-single-select\",null,[[\"dd\",\"elseMessage\",\"dropdownClass\",\"textIcon\",\"value\",\"options\",\"displayKey\"],[[19,14,[]],\"You don't have any question shared with you that belongs to selected data source\",\"menu-content\",\"Q\",[20,[\"queryObject\",\"table\"]],[20,[\"questions\"]],\"title\"]]],false],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"                \"],[1,[25,\"custom-single-select\",null,[[\"dd\",\"dropdownClass\",\"helpText\",\"textIcon\",\"value\",\"options\",\"displayKey\"],[[19,14,[]],\"menu-content\",\"If a question is already shared with you and you want to build your query\\n                on that question, change source to question by clicking\",\"T\",[20,[\"queryObject\",\"table\"]],[20,[\"tables\"]],\"human_name\"]]],false],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[14]},null],[0,\"\\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,13,[\"toggle\"]]],[[\"class\"],[\"btn tag-size mt-1 datasource-selector btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[0,\"        \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\" \"],[4,\"if\",[[20,[\"queryObject\",\"fromQuestion\"]]],null,{\"statements\":[[0,\"Question\"]],\"parameters\":[]},{\"statements\":[[0,\"Table\"]],\"parameters\":[]}],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[20,[\"queryObject\",\"fromQuestion\"]]],null,{\"statements\":[[0,\"        \"],[1,[25,\"custom-single-select\",null,[[\"dd\",\"elseMessage\",\"dropdownClass\",\"textIcon\",\"value\",\"options\",\"displayKey\"],[[19,13,[]],\"You don't have any question shared with you that belongs to selected data source\",\"menu-content\",\"Q\",[20,[\"queryObject\",\"table\"]],[20,[\"questions\"]],\"title\"]]],false],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"        \"],[1,[25,\"custom-single-select\",null,[[\"dd\",\"helpText\",\"dropdownClass\",\"textIcon\",\"value\",\"options\",\"displayKey\"],[[19,13,[]],\"If a question is already shared with you and you want to build your query\\n                on that question, change source to question by clicking\",\"menu-content\",\"T\",[20,[\"queryObject\",\"table\"]],[20,[\"tables\"]],\"human_name\"]]],false],[0,\"\\n\"]],\"parameters\":[]}],[0,\"\\n\"]],\"parameters\":[13]},null]],\"parameters\":[]}],[0,\"\\n    \"],[8],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"col-1 p-1 text-right\"],[7],[0,\"\\n        \"],[6,\"span\"],[9,\"class\",\"d-inline-flex\"],[3,\"action\",[[19,0,[]],\"toggleFromTable\"]],[7],[0,\"\\n            \"],[4,\"bs-tooltip\",null,[[\"placement\"],[\"top\"]],{\"statements\":[[0,\"Switch between Question and Table\"]],\"parameters\":[]},null],[0,\"\\n            \"],[6,\"i\"],[9,\"class\",\"fe fe-toggle-right\"],[7],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\\n\"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[20,[\"canShowFilters\"]]],null,{\"statements\":[[6,\"div\"],[9,\"class\",\"card-footer\"],[7],[0,\"\\n\\n\"],[4,\"each\",[[20,[\"queryObject\",\"filters\"]]],null,{\"statements\":[[4,\"if\",[[25,\"label-maker\",[[19,11,[]],[19,11,[\"column\"]],[19,11,[\"value\"]],[19,11,[\"valueDateObj\",\"value\"]],[19,11,[\"valueDateObj\",\"duration\"]],[19,11,[\"operator\"]],[19,11,[\"valueDateObj\",\"date\"]],[19,11,[\"valueDateObj\",\"dtt\",\"name\"]]],null]],null,{\"statements\":[[0,\"    \"],[6,\"span\"],[9,\"class\",\"tag border tag-primary mt-1\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,12,[\"toggle\"]]],[[\"class\"],[\"text-white\"]],{\"statements\":[[0,\"        \"],[1,[25,\"label-maker\",[[19,11,[]],[19,11,[\"column\"]],[19,11,[\"value\"]],[19,11,[\"valueDateObj\",\"value\"]],[19,11,[\"valueDateObj\",\"duration\"]],[19,11,[\"operator\"]],[19,11,[\"valueDateObj\",\"date\"]],[19,11,[\"valueDateObj\",\"dtt\",\"name\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"        \"],[1,[25,\"filter-maker\",null,[[\"dd\",\"filter\",\"columns\",\"switchToBuilder\",\"switchToRaw\"],[[19,12,[]],[19,11,[]],[20,[\"columns\"]],\"switchToBuilder\",\"switchToRaw\"]]],false],[0,\"\\n\"]],\"parameters\":[12]},null],[0,\"        \"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"tag-addon\"],[7],[0,\"\\n            \"],[6,\"i\"],[9,\"class\",\"fe fe-x text-white\"],[3,\"action\",[[19,0,[]],\"remove\",\"filters\",[19,11,[]]]],[7],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[11]},null],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,10,[\"toggle\"]]],[[\"class\"],[\"btn tag-size mt-1 btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[0,\"    \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\" Filter\\n\"]],\"parameters\":[]},null],[0,\"    \"],[1,[25,\"filter-maker\",null,[[\"dd\",\"showAddFilter\",\"addNewFilter\",\"filter\",\"columns\",\"switchToBuilder\",\"switchToRaw\"],[[19,10,[]],true,\"addNewFilter\",[20,[\"newFilter\"]],[20,[\"columns\"]],\"switchToBuilder\",\"switchToRaw\"]]],false],[0,\"\\n\"]],\"parameters\":[10]},null],[0,\"\\n\"],[8],[0,\"\\n\"],[6,\"div\"],[9,\"class\",\"card-footer\"],[7],[0,\"\\n\\n\"],[4,\"each\",[[20,[\"queryObject\",\"views\"]]],null,{\"statements\":[[4,\"if\",[[25,\"label-maker\",[[19,8,[]],[19,8,[\"selected\",\"raw\"]],[19,8,[\"selected\",\"value\"]],[19,8,[\"selected\",\"name\"]],[19,8,[\"selected\"]]],null]],null,{\"statements\":[[0,\"    \"],[6,\"span\"],[9,\"class\",\"tag tag-primary border mt-1\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,9,[\"toggle\"]]],[[\"class\"],[\"text-white\"]],{\"statements\":[[0,\"        \"],[1,[25,\"label-maker\",[[19,8,[]],[19,8,[\"selected\"]],[19,8,[\"selected\",\"value\"]],[19,8,[\"selected\",\"raw\"]],[19,8,[\"selected\",\"name\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"        \"],[1,[25,\"view-maker\",null,[[\"dd\",\"addNewView\",\"selectView\",\"switchToBuilder\",\"switchToRaw\"],[[19,9,[]],\"addNewView\",[19,8,[]],\"switchToBuilder\",\"switchToRaw\"]]],false],[0,\"\\n\"]],\"parameters\":[9]},null],[0,\"        \"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"tag-addon\"],[7],[0,\"\\n            \"],[6,\"i\"],[9,\"class\",\"fe fe-x text-white\"],[3,\"action\",[[19,0,[]],\"remove\",\"views\",[19,8,[]]]],[7],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[8]},null],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,7,[\"toggle\"]]],[[\"class\"],[\"btn tag-size mt-1 btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[0,\"    \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"View\\n\"]],\"parameters\":[]},null],[0,\"    \"],[1,[25,\"view-maker\",null,[[\"dd\",\"showAddView\",\"addNewView\",\"selectView\",\"switchToBuilder\",\"switchToRaw\"],[[19,7,[]],true,\"addNewView\",[20,[\"newView\"]],\"switchToBuilder\",\"switchToRaw\"]]],false],[0,\"\\n\"]],\"parameters\":[7]},null],[8],[0,\"\\n\"],[6,\"div\"],[9,\"class\",\"card-footer\"],[7],[0,\"\\n\\n\"],[4,\"each\",[[20,[\"queryObject\",\"groupBys\"]]],null,{\"statements\":[[4,\"if\",[[25,\"label-maker\",[[19,5,[]],[19,5,[\"castType\"]],[19,5,[\"selected\"]],[19,5,[\"selected\",\"value\"]],[19,5,[\"selected\",\"raw\"]]],null]],null,{\"statements\":[[0,\"    \"],[6,\"span\"],[9,\"class\",\"tag border tag-primary mt-1\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,6,[\"toggle\"]]],[[\"class\"],[\"text-white\"]],{\"statements\":[[0,\"        \"],[1,[25,\"label-maker\",[[19,5,[]],[19,5,[\"castType\"]],[19,5,[\"selected\"]],[19,5,[\"selected\",\"value\"]],[19,5,[\"selected\",\"raw\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"        \"],[1,[25,\"group-by-maker\",null,[[\"dd\",\"columns\",\"groupBy\",\"switchToRaw\",\"switchToBuilder\"],[[19,6,[]],[20,[\"columns\"]],[19,5,[]],\"switchToRaw\",\"switchToBuilder\"]]],false],[0,\"\\n\"]],\"parameters\":[6]},null],[0,\"        \"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"tag-addon\"],[7],[0,\"\\n            \"],[6,\"i\"],[9,\"class\",\"fe fe-x text-white\"],[3,\"action\",[[19,0,[]],\"remove\",\"groupBys\",[19,5,[]]]],[7],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[5]},null],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,4,[\"toggle\"]]],[[\"class\"],[\"btn tag-size mt-1 btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[0,\"    \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"Grouping\\n\"]],\"parameters\":[]},null],[0,\"    \"],[1,[25,\"group-by-maker\",null,[[\"dd\",\"showAddGroupBy\",\"addNewGroupBy\",\"columns\",\"groupBy\",\"switchToRaw\",\"switchToBuilder\"],[[19,4,[]],true,\"addNewGroupBy\",[20,[\"columns\"]],[20,[\"newGroupBy\"]],\"switchToRaw\",\"switchToBuilder\"]]],false],[0,\"\\n\"]],\"parameters\":[4]},null],[8],[0,\"\\n\\n\"],[6,\"div\"],[9,\"class\",\"card-footer\"],[7],[0,\"\\n\\n\"],[4,\"each\",[[20,[\"queryObject\",\"orderBys\"]]],null,{\"statements\":[[4,\"if\",[[25,\"label-maker\",[[19,2,[]],[19,2,[\"column\"]],[19,2,[\"order\"]]],null]],null,{\"statements\":[[0,\"    \"],[6,\"span\"],[9,\"class\",\"tag border tag-primary mt-1\"],[7],[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,3,[\"toggle\"]]],[[\"class\"],[\"text-white\"]],{\"statements\":[[0,\"        \"],[1,[25,\"label-maker\",[[19,2,[]],[19,2,[\"column\"]],[19,2,[\"order\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n        \"],[1,[25,\"order-by-maker\",null,[[\"dd\",\"columns\",\"orderBy\"],[[19,3,[]],[20,[\"columns\"]],[19,2,[]]]]],false],[0,\"\\n\"]],\"parameters\":[3]},null],[0,\"        \"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"tag-addon\"],[7],[0,\"\\n            \"],[6,\"i\"],[9,\"class\",\"fe fe-x text-white\"],[3,\"action\",[[19,0,[]],\"remove\",\"orderBys\",[19,2,[]]]],[7],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[2]},null],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\"],[false]],{\"statements\":[[4,\"component\",[[19,1,[\"toggle\"]]],[[\"class\"],[\"btn tag-size mt-1 btn-secondary text-primary border-primary py-0 px-1\"]],{\"statements\":[[0,\"    \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"Sort Order\\n\"]],\"parameters\":[]},null],[0,\"    \"],[1,[25,\"order-by-maker\",null,[[\"dd\",\"showAddOrderBy\",\"addNewOrderBy\",\"columns\",\"orderBy\"],[[19,1,[]],true,\"addNewOrderBy\",[20,[\"columns\"]],[20,[\"newOrderBy\"]]]]],false],[0,\"\\n\"]],\"parameters\":[1]},null],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/subquery-builder/template.hbs" } });
});
...
define("frontend/pods/components/transposed-results-table-settings/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "+2Qjo+Dk", "block": "{\"symbols\":[],\"statements\":[[1,[25,\"results-table-settings\",null,[[\"canEdit\",\"resultsViewSettings\",\"results\"],[[20,[\"canEdit\"]],[20,[\"resultsViewSettings\"]],[20,[\"results\"]]]]],false]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/transposed-results-table-settings/template.hbs" } });
});
define('frontend/pods/components/transposed-results-table/component', ['exports', 'ember', 'ember-light-table', 'ember-cli-pagination/computed/paged-array'], function (exports, _ember, _emberLightTable, _emberCliPaginationComputedPagedArray) {
    var computed = _ember['default'].computed;
    var observer = _ember['default'].observer;
    exports['default'] = _ember['default'].Component.extend({

        transposedResults: _ember['default'].computed('pagedRows', 'page', function () {

            var transposedResults = _ember['default'].Object.create({
                content: _ember['default'].A([]),
                page: this.get('page')
            });
            if (this.get('pagedRows')) {
                this.get('results.columns') && this.get('results.columns').forEach(function (el) {
                    transposedResults.get('content').pushObject(_ember['default'].A([el]));
                });
                this.get('pagedRows') && this.get('pagedRows').forEach(function (el, index) {
                    el.forEach(function (element, i2) {
...
define("frontend/pods/components/transposed-results-table/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "s/hjJLA0", "block": "{\"symbols\":[\"apiAction\",\"col\",\"col_index\",\"row\",\"i\",\"el\",\"index\"],\"statements\":[[6,\"div\"],[9,\"class\",\"table-responsive\"],[7],[0,\"\\n    \"],[6,\"table\"],[9,\"class\",\"table table-hover table-outline table-vcenter text-nowrap card-table table-striped\"],[7],[0,\"\\n        \"],[6,\"tbody\"],[7],[0,\"\\n\"],[4,\"each\",[[20,[\"transposedResults\",\"content\"]]],null,{\"statements\":[[0,\"            \"],[6,\"tr\"],[7],[0,\"\\n\"],[4,\"each\",[[19,4,[]]],null,{\"statements\":[[4,\"if\",[[25,\"eq\",[[19,7,[]],0],null]],null,{\"statements\":[[4,\"unless\",[[25,\"exists-in-array\",[[20,[\"question\",\"results_view_settings\",\"hiddenColumns\"]],[19,6,[]]],null]],null,{\"statements\":[[0,\"                \"],[6,\"th\"],[9,\"class\",\"\"],[7],[0,\"\\n                    \"],[1,[25,\"widgets/render-widgets\",null,[[\"class\",\"el\",\"question\",\"index\",\"results\"],[\"d-inline\",[25,\"capitalize\",[[19,6,[]]],null],[20,[\"question\"]],[19,7,[]],[20,[\"results\"]]]]],false],[0,\"\\n\"],[4,\"if\",[[25,\"replace-column-with-api-action\",[[20,[\"question\",\"api_actions\"]],[19,6,[]],[20,[\"question\",\"apiActionsChanged\"]]],null]],null,{\"statements\":[[0,\"\\n\"],[4,\"if\",[[20,[\"canEdit\"]]],null,{\"statements\":[[0,\"                    \"],[6,\"i\"],[9,\"class\",\"fe fe-edit text-primary\"],[3,\"action\",[[19,0,[]],\"editApiAction\",[25,\"replace-column-with-api-action\",[[20,[\"question\",\"api_actions\"]],[19,6,[]],[20,[\"question\",\"apiActionsChanged\"]]],null]]],[7],[8],[0,\"\\n                    \"],[6,\"i\"],[9,\"class\",\"fe fe-x-square text-red\"],[3,\"action\",[[19,0,[]],\"showDeleteApiActionModal\",[25,\"replace-column-with-api-action\",[[20,[\"question\",\"api_actions\"]],[19,6,[]],[20,[\"question\",\"apiActionsChanged\"]]],null]]],[7],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[0,\"                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},{\"statements\":[[4,\"unless\",[[25,\"exists-in-array\",[[20,[\"question\",\"results_view_settings\",\"hiddenColumns\"]],[25,\"get-in\",[[20,[\"results\",\"columns\"]],[19,5,[]]],null]],null]],null,{\"statements\":[[0,\"                \"],[6,\"td\"],[9,\"class\",\"\"],[7],[0,\"\\n\"],[4,\"if\",[[25,\"replace-column-with-api-action\",[[20,[\"question\",\"api_actions\"]],[25,\"get-in\",[[20,[\"results\",\"columns\"]],[19,5,[]]],null],[20,[\"question\",\"apiActionsChanged\"]]],null]],null,{\"statements\":[[0,\"                    \"],[6,\"div\"],[10,\"class\",[26,[\"btn btn-link text-\",[25,\"get\",[[25,\"replace-column-with-api-action\",[[20,[\"question\",\"api_actions\"]],[25,\"get-in\",[[20,[\"results\",\"columns\"]],[19,5,[]]],null],[20,[\"question\",\"apiActionsChanged\"]]],null],\"color\"],null],\" text-uppercase p-0\"]]],[3,\"action\",[[19,0,[]],\"callApiAction\",[25,\"replace-column-with-api-action\",[[20,[\"question\",\"api_actions\"]],[25,\"get-in\",[[20,[\"results\",\"columns\"]],[19,5,[]]],null],[20,[\"question\",\"apiActionsChanged\"]]],null],[25,\"get-row\",[[20,[\"results\",\"rows\"]],[20,[\"page\"]],[20,[\"perPage\"]],[19,7,[]]],null]]],[7],[0,\"\\n                        \"],[1,[25,\"get-api-action-display-name\",[[25,\"get-row\",[[20,[\"results\",\"rows\"]],[20,[\"page\"]],[20,[\"perPage\"]],[19,7,[]]],null],[20,[\"results\",\"columns\"]],[25,\"get\",[[25,\"replace-column-with-api-action\",[[20,[\"question\",\"api_actions\"]],[25,\"get-in\",[[20,[\"results\",\"columns\"]],[19,5,[]]],null],[20,[\"question\",\"apiActionsChanged\"]]],null],\"name\"],null]],null],false],[0,\"\\n                    \"],[8],[0,\"\\n\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"if\",[[25,\"exists-in\",[[19,7,[]],[20,[\"results\"]]],null]],null,{\"statements\":[[4,\"link-to\",[\"explore.new\",[25,\"get-column-id\",[[19,7,[]],[20,[\"results\"]]],null],[19,6,[]]],null,{\"statements\":[[0,\"                    \"],[1,[25,\"widgets/render-widgets\",null,[[\"el\",\"question\",\"index\",\"results\"],[[19,6,[]],[20,[\"question\"]],[19,7,[]],[20,[\"results\"]]]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"                    \"]],\"parameters\":[]},{\"statements\":[[1,[25,\"widgets/render-widgets\",null,[[\"el\",\"question\",\"index\",\"results\"],[[19,6,[]],[20,[\"question\"]],[19,7,[]],[20,[\"results\"]]]]],false],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[]}],[0,\"                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]}]],\"parameters\":[6,7]},null],[0,\"\\n            \"],[8],[0,\"\\n\"]],\"parameters\":[4,5]},{\"statements\":[],\"parameters\":[]}],[4,\"each\",[[20,[\"question\",\"api_actions\"]]],null,{\"statements\":[[4,\"if\",[[25,\"not\",[[19,1,[\"column\"]]],null]],null,{\"statements\":[[0,\"            \"],[6,\"tr\"],[7],[0,\"\\n\\n                \"],[6,\"th\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"canEdit\"]]],null,{\"statements\":[[0,\"                    \"],[6,\"i\"],[9,\"class\",\"fe fe-edit text-primary\"],[3,\"action\",[[19,0,[]],\"editApiAction\",[19,1,[]]]],[7],[8],[0,\"\\n                    \"],[6,\"i\"],[9,\"class\",\"fe fe-x-square text-red\"],[3,\"action\",[[19,0,[]],\"showDeleteApiActionModal\",[19,1,[]]]],[7],[8],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"                \"],[8],[0,\"\\n\"],[4,\"each\",[[20,[\"transposedResults\",\"content\",\"0\"]]],null,{\"statements\":[[4,\"unless\",[[25,\"eq\",[[19,3,[]],0],null]],null,{\"statements\":[[0,\"                \"],[6,\"td\"],[7],[0,\"\\n                    \"],[6,\"div\"],[10,\"class\",[26,[\"btn btn-link text-\",[19,1,[\"color\"]],\" text-uppercase p-0\"]]],[3,\"action\",[[19,0,[]],\"callApiAction\",[19,1,[]],[25,\"get-row\",[[20,[\"results\",\"rows\"]],[20,[\"page\"]],[20,[\"perPage\"]],[19,3,[]]],null]]],[7],[0,\"\\n                        \"],[1,[25,\"get-api-action-display-name\",[[25,\"get-row\",[[20,[\"results\",\"rows\"]],[20,[\"page\"]],[20,[\"perPage\"]],[19,3,[]]],null],[20,[\"results\",\"columns\"]],[19,1,[\"name\"]]],null],false],[0,\"\\n                    \"],[8],[0,\"\\n\\n                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[2,3]},null],[0,\"\\n            \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[1]},null],[0,\"        \"],[8],[0,\"\\n\"],[4,\"if\",[[20,[\"showPageNumbers\"]]],null,{\"statements\":[[0,\"        \"],[6,\"tfoot\"],[9,\"class\",\"full-width\"],[7],[0,\"\\n            \"],[6,\"tr\"],[7],[0,\"\\n                \"],[6,\"th\"],[9,\"colspan\",\"100\"],[9,\"class\",\"p-0 pt-5\"],[7],[0,\"\\n                    \"],[4,\"if\",[[20,[\"showResults\"]]],null,{\"statements\":[[0,\" \"],[1,[25,\"page-numbers\",null,[[\"content\"],[[20,[\"pagedRows\"]]]]],false],[0,\" \"]],\"parameters\":[]},{\"statements\":[[0,\"\\n                    \"],[6,\"div\"],[9,\"class\",\"centered\"],[7],[0,\" Looks like your query did not return any result. \"],[8],[0,\"\\n\"]],\"parameters\":[]}],[0,\"                \"],[8],[0,\"\\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"    \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"],[1,[25,\"delete-dialogue\",null,[[\"entityName\",\"open\",\"entity\",\"delete\"],[\"Api Action\",[20,[\"toggleDeleteApiActionModal\"]],[20,[\"deletableApiAction\"]],\"deleteApiAction\"]]],false],[0,\"\\n\"],[1,[25,\"api-action-modal\",null,[[\"apiAction\",\"open\",\"results\",\"question\"],[[20,[\"editableApiAction\"]],[20,[\"toggleEditApiActionModal\"]],[20,[\"results\"]],[20,[\"question\"]]]]],false],[0,\"\\n\"],[1,[25,\"api-action-result\",null,[[\"canDebug\",\"result\",\"open\"],[[20,[\"canEdit\"]],[20,[\"apiActionResult\"]],[20,[\"toggleApiActionResult\"]]]]],false]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/transposed-results-table/template.hbs" } });
});
...
define('frontend/pods/components/variables-layer/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    actions: {
      ...
      selectVariableValue: function selectVariableValue(variable, value) {
...
define("frontend/pods/components/variables-layer/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "y7udExVa", "block": "{\"symbols\":[\"variable\",\"dd\",\"ddm\"],\"statements\":[[6,\"div\"],[9,\"class\",\"row tags mb-2\"],[7],[0,\"\\n\"],[4,\"each\",[[20,[\"variables\"]]],null,{\"statements\":[[0,\"\\n\"],[4,\"bs-dropdown\",null,[[\"closeOnMenuClick\",\"class\"],[false,\"tag tag-primary\"]],{\"statements\":[[4,\"component\",[[19,2,[\"toggle\"]]],[[\"class\"],[\"text-white \"]],{\"statements\":[[0,\"    \"],[1,[25,\"capitalize\",[[19,1,[\"name\"]]],null],false],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"tag-addon\"],[7],[0,\"\\n\"],[4,\"if\",[[25,\"or\",[[19,1,[\"date_value\"]],[19,1,[\"value\"]]],null]],null,{\"statements\":[[0,\"        \"],[1,[25,\"format-object\",[[25,\"or\",[[19,1,[\"date_value\"]],[25,\"or\",[[19,1,[\"displayValue\"]],[19,1,[\"value\"]]],null]],null]],null],false],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"        Select Value\\n\"]],\"parameters\":[]}],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[19,2,[\"menu\"]]],[[\"renderInPlace\"],[false]],{\"statements\":[[4,\"if\",[[19,1,[\"showDatePicker\"]]],null,{\"statements\":[[0,\"\\n    \"],[1,[25,\"bs-datetimepicker\",null,[[\"class\",\"date\",\"inline\",\"useCurrent\"],[\"d-block\",[19,1,[\"date_value\"]],true,\"day\"]]],false],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"if\",[[19,1,[\"showMultiSelect\"]]],null,{\"statements\":[[0,\"    \"],[1,[25,\"custom-single-select-content\",null,[[\"selectCallbackAction\",\"dropdownClass\",\"elseMessage\",\"options\",\"value\",\"displayKey\"],[[25,\"action\",[[19,0,[]],\"selectVariableValue\",[19,1,[]]],null],\"menu-content max-height-400\",\"No matching value\",[19,1,[\"questionFilterOptions\"]],[20,[\"tempValue\"]],\"name\"]]],false],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"value\",\"placeholder\"],[\"form-control\",\"text\",[19,1,[\"value\"]],[19,1,[\"default\"]]]]],false],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[]}]],\"parameters\":[3]},null]],\"parameters\":[2]},null]],\"parameters\":[1]},null],[8]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/variables-layer/template.hbs" } });
});
...
define("frontend/pods/components/view-maker/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "PHjtlaj/", "block": "{\"symbols\":[\"ddm\"],\"statements\":[[4,\"component\",[[20,[\"dd\",\"menu\"]]],[[\"renderInPlace\"],[false]],{\"statements\":[[6,\"div\"],[9,\"class\",\"menu-content\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"selectView\",\"selected\",\"raw\"]]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"switch\"],[3,\"action\",[[19,0,[]],\"switchToBuilder\",\"views\",[20,[\"selectView\"]],true]],[7],[0,\" \"],[1,[25,\"bs-tooltip\",null,[[\"title\"],[\"Switch To Builder\"]]],false],[0,\"\\n        \"],[6,\"i\"],[9,\"class\",\"fe fe-list text-gray\"],[7],[8],[0,\"\\n    \"],[8],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n        \"],[1,[25,\"input\",null,[[\"value\",\"class\",\"placeholder\"],[[20,[\"selectView\",\"selected\",\"value\"]],\"form-control my-2\",\"COUNT(column) As Metric\"]]],false],[0,\"\\n    \"],[8],[0,\"\\n    \"],[6,\"small\"],[9,\"class\",\"text-muted\"],[7],[0,\"You can add view fragments like avg(columns), count(column), sum(column) etc here. See\\n        Database documentation for more such functions.\"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"switch\"],[3,\"action\",[[19,0,[]],\"switchToRaw\",\"views\",[20,[\"selectView\"]],true]],[7],[0,\" \"],[1,[25,\"bs-tooltip\",null,[[\"title\"],[\"Switch To Raw\"]]],false],[0,\"\\n        \"],[6,\"i\"],[9,\"class\",\"fe fe-code text-gray\"],[7],[8],[0,\"\\n    \"],[8],[0,\"\\n    \"],[1,[25,\"custom-single-select-content\",null,[[\"elseMessage\",\"selectCallbackAction\",\"options\",\"value\",\"hideSearch\",\"helpText\",\"displayKey\"],[\"No Such View is supported. Use Raw for complex views\",\"addNewView\",[20,[\"viewOptions\"]],[20,[\"selectView\",\"selected\"]],true,\"To view average, sum and more complex manipulation on your data, switch to raw by clicking\\n        <i class=\\\"fe fe-code text-gray\\\"></i>\",\"name\"]]],false],[0,\"\\n\\n\"]],\"parameters\":[]}],[4,\"if\",[[20,[\"showAddView\"]]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"btn btn-primary mt-2 w-100\"],[3,\"action\",[[19,0,[]],\"addNewView\"]],[7],[0,\" \"],[6,\"i\"],[9,\"class\",\"fe fe-plus\"],[7],[8],[0,\"\\n        Add\\n        View\"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"class\",\"btn btn-primary mt-2 w-100\"],[3,\"action\",[[19,0,[]],\"close\"]],[7],[0,\"\\n        Done\"],[8],[0,\"\\n\"]],\"parameters\":[]}],[8],[0,\"\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/view-maker/template.hbs" } });
});
define('frontend/pods/components/vim-easymotion/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    didInsertElement: function didInsertElement() {
      ...
      $(document).on('keyup', function (e) {
        if (['TEXTAREA', 'INPUT'].indexOf(e.target.tagName) < 0) {
          if (!_this.get('enabled')) {
            if (e.key == 's') {
              _this.activateEasyMotion();
            }
          } else {
            _this.cleanup(e.key);
          }
          if (e.key == 'Escape') {
            _this.disableEasymotion();
          }
        }
        return;
      });
    },
    cleanup: function cleanup(key) {
      var _this2 = this;

      var allKeysPressed = this.get('pressedKeys').join('') + key;
      var newAssignmentList = this.get('assignmentList').filter(function (el) {
      ...
      if (newAssignmentList.length == 0) {
        ...
        var newAssignmentMap = _ember['default'].Object.create();
        this.$().html('');
        newAssignmentList.forEach(function (el) {
          var assignmentMap = _this2.get('assignmentMap');
          _this2.createEasymotionElements(assignmentMap.get(el), el.split(''));
    ...
    disableEasymotion: function disableEasymotion() {
      this.set('pressedKeys', []);
      this.set('assignmentList', []);
      this.set('assignemntMap', _ember['default'].Object.create());
      this.set('enabled', false);
      this.$().html('');
    },
    createEasymotionElements: function createEasymotionElements(el, letters) {
    ...
    generateAssignmentList: function generateAssignmentList(length) {
    ...
    activateEasyMotion: function activateEasyMotion() {
      ...
      this.set('assignmentMap', _ember['default'].Object.create());
...
define("frontend/pods/components/vim-easymotion/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "upMs6gYX", "block": "{\"symbols\":[\"&default\"],\"statements\":[[11,1]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/components/vim-easymotion/template.hbs" } });
});
...
define('frontend/pods/dashboards/show/controller', ['exports', 'ember', 'frontend/config/environment', 'frontend/mixins/dynamic-query-params-controller-mixin'], function (exports, _ember, _frontendConfigEnvironment, _frontendMixinsDynamicQueryParamsControllerMixin) {
  exports['default'] = _ember['default'].Controller.extend(_frontendMixinsDynamicQueryParamsControllerMixin['default'], {
    ...
    dashboardPath: _ember['default'].computed('dashboard', 'dashboard.variables.content.isLoaded', function () {
      var dashboard = this.get('dashboard');

      var payload = { variables: [], iFrame: true };
      if (dashboard.get('variables.content.isLoaded')) {
        var query_variables = dashboard.get('variables').map(function (item) {
          return {
            name: item.get('name'),
            value: item.get('value') || item.get('default'),
            var_type: item.get('var_type'),
      ...
      return _frontendConfigEnvironment['default'].vueHost + '/frontend' + window.location.pathname + "?payload=" + JSON.stringify(payload) + "&token=" + this.get('ajax.sessionService.token');
    }),
    ...
    refreshFunction: function refreshFunction() {
      ...
      var variables = this.get('dashboard.variables').map(function (item) {
        return {
          name: item.get('name'),
          value: item.get('value') || item.get('default'),
          var_type: item.get('var_type'),
      ...
      var payload = { iFrame: true, variables: variables };
    ...
    actions: {
      ...
      scheduleDashboard: function scheduleDashboard() {
        if (document.getElementById(this.get('vueIframeID'))) {
          document.getElementById(this.get('vueIframeID')).contentWindow.postMessage({
...
define('frontend/pods/data-references/databases/show/tables/show/explore/controller', ['exports', 'ember', 'frontend/pods/questions/new/controller', 'frontend/pods/data-references/databases/show/tables/show/controller', 'frontend/mixins/result-view-mixin', 'ember-can'], function (exports, _ember, _frontendPodsQuestionsNewController, _frontendPodsDataReferencesDatabasesShowTablesShowController, _frontendMixinsResultViewMixin, _emberCan) {
    exports['default'] = _frontendPodsQuestionsNewController['default'].extend(_frontendMixinsResultViewMixin['default'], _emberCan.CanMixin, {
        ...
        questionObserver: _ember['default'].observer("question.database", "vueResultPath", function () {
            var _this = this;

            if (this.get('question.human_sql.database') && this.get('question.human_sql.table') && this.get('vueResultPath')) {
                setTimeout(function () {
                    _this.getResultsFunction(null);
                }, 1000);
            }
        })
    });
  ...
  exports['default'] = _ember['default'].Controller.extend({
    ...
    actions: {
      ...
      createDashboard: function createDashboard() {
        ...
        this.get('ajax').apiCall({
          method: 'POST',
          url: this.get('ajax.apiPath') + '/explore/create_dashboard' + '?column_id=' + this.get('params.column_id') + '&value=' + this.get('params.column_value'),
          type: 'GET'
        }, function (response, status) {
          _this.transitionToRoute('dashboards.show', response.data.id, { queryParams: { "autoRefresh": true } });
        }, function (error, status) {
          reject(error);
        });
      }
...
define('frontend/pods/login/controller', ['exports', 'ember'], function (exports, _ember) {
    exports['default'] = _ember['default'].Controller.extend({
        ...
        sessionService: _ember['default'].inject.service(),
        login: _ember['default'].Object.create(),

        apiHost: _ember['default'].computed('store', function () {
            return this.get('store').adapterFor('application').host;
        }),

        loginObserver: _ember['default'].on('init', _ember['default'].observer('login.username', 'login.password', function () {
        ...
        actions: {
            ...
            loginWithPassword: function loginWithPassword() {
                ...
                this.get('ajax').apiCall({
                    ...
                    _this.set('loginError', "Invalid email/ Password");
                });
            }
        }
    });
...
define("frontend/pods/login/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "oQQIEqZl", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[9,\"class\",\"page\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"page-single\"],[7],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"container\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n                \"],[6,\"div\"],[9,\"class\",\"col col-login mx-auto mt-9\"],[7],[0,\"\\n                    \"],[6,\"form\"],[9,\"class\",\"card p-4\"],[9,\"action\",\"\"],[9,\"method\",\"post\"],[7],[0,\"\\n                        \"],[6,\"div\"],[9,\"class\",\"text-center mb-6\"],[7],[0,\" \"],[1,[25,\"app-logo\",null,[[\"logoSize\"],[\"big\"]]],false],[0,\" \"],[8],[0,\"\\n                        \"],[6,\"div\"],[9,\"class\",\"text-center\"],[7],[0,\"\\n                            \"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"btn btn-link text-google\"],[3,\"action\",[[19,0,[]],\"loginWithGoogle\"]],[7],[0,\" LOGIN WITH GOOGLE \"],[8],[0,\"\\n                        \"],[8],[0,\"\\n                    \"],[8],[0,\"\\n                \"],[8],[0,\"\\n                \"],[6,\"div\"],[9,\"class\",\"col col-login mx-auto mt-9\"],[7],[0,\"\\n\"],[6,\"form\"],[9,\"class\",\"card p-4\"],[9,\"action\",\"\"],[9,\"method\",\"post\"],[7],[0,\"\\n \"],[1,[25,\"input\",null,[[\"value\",\"class\",\"placeholder\",\"aria-describedby\"],[[20,[\"login\",\"email\"]],[25,\"if\",[[20,[\"usernameError\"]],\"is-invalid ui form-control \",\"ui form-control \"],null],\"email\",\"basic-addon3\"]]],false],[0,\"    \\n \"],[1,[25,\"input\",null,[[\"value\",\"class\",\"placeholder\",\"aria-describedby\",\"type\"],[[20,[\"login\",\"password\"]],[25,\"if\",[[20,[\"passwordError\"]],\"is-invalid ui form-control mt-2\",\"ui form-control mt-2\"],null],\"password\",\"basic-addon3\",\"password\"]]],false],[0,\"                   \\n\\n  \"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"btn btn-primary mt-4\"],[3,\"action\",[[19,0,[]],\"loginWithPassword\"]],[7],[0,\" LOGIN \"],[8],[0,\"\\n                    \"],[8],[0,\"\\n                \"],[8],[0,\"\\n            \"],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/login/template.hbs" } });
});
...
define('frontend/pods/questions/new/controller', ['exports', 'ember', 'frontend/mixins/chart-settings', 'frontend/mixins/loading-messages', 'frontend/mixins/result-view-mixin', 'frontend/mixins/custom-events', 'frontend/mixins/ace-tools', 'frontend/mixins/helper-mixin', 'frontend/mixins/dynamic-query-params-controller-mixin', 'frontend/config/environment'], function (exports, _ember, _frontendMixinsChartSettings, _frontendMixinsLoadingMessages, _frontendMixinsResultViewMixin, _frontendMixinsCustomEvents, _frontendMixinsAceTools, _frontendMixinsHelperMixin, _frontendMixinsDynamicQueryParamsControllerMixin, _frontendConfigEnvironment) {
  exports['default'] = _ember['default'].Controller.extend(_frontendMixinsLoadingMessages['default'], _frontendMixinsChartSettings['default'], _frontendMixinsHelperMixin['default'], _frontendMixinsResultViewMixin['default'], _frontendMixinsAceTools['default'], _frontendMixinsCustomEvents['default'], _frontendMixinsDynamicQueryParamsControllerMixin['default'], {

    vueComponentsEnabled: true,
    vueIframeID: 'vueResultsComponent',
    vueResultPath: _ember['default'].computed('question.query_variables.content.isLoaded', 'question.database', function () {
      var question = this.get('question');
      if (question.get('query_variables.content.isLoaded')) {
        var query_variables = question.get('query_variables').map(function (item) {
          return {
            name: item.get('name'),
            value: item.get('value') || item.get('default'),
            var_type: item.get('var_type'),
        ...
        var payload = { variables: query_variables, iFrame: true };
        return _frontendConfigEnvironment['default'].vueHost + '/frontend' + window.location.pathname + "?payload=" + JSON.stringify(payload) + "&token=" + this.get('ajax.sessionService.token');
      }
      return "";
    }),
    ...
    isApiClientQuery: _ember['default'].computed('question.query_type', function () {
    ...
    availableResultsTypesHash: _ember['default'].computed('availableResultsTypes', function () {
      ...
      return Object.keys(this.get('resultsWidgets')).map(function (item) {
        return _ember['default'].Object.create({
          title: item,
          icon: _this.get('resultViewIcons')[item.toLowerCase()],
          columnClass: _this.get('resultViewIconsColumnClass')[item.toLowerCase()]
        });
      });
    }),
    ...
    scrollToResultsView: function scrollToResultsView() {
      var iframeOffset = $('#' + this.get('vueIframeID')).offset();
      if (iframeOffset) {
        $('html, body').animate({
    ...
    getResultsFunction: function getResultsFunction(queryObject, withSelected) {
      ...
      if (question.get('query_type') == 'api_client') {
        var _ret = (function () {
          var payload = JSON.parse(JSON.stringify(question.get('api_action.content')));
          payload["variables"] = queryObject.get('variables');
          var apiAction = question.get('api_action.content');
          apiAction.preview(payload).then(function (response) {

            _this2.set('loading', false);
            if (response.status_code == 0 || response.status_code >= 400) {
              _this2.set('errors', "Error: " + response.response_body);
              _this2.set('results', null);
            } else {
              var results = _this2.parseApiActionResult(response, apiAction);
      ...
      var iframe = document.getElementById(this.get('vueIframeID'));
      if (iframe) {
      ...
      this.get('ajax').apiCall({
        ...
        if (!(withSelected && _this2.get('aceEditor') && _this2.get('aceEditor').getSelectedText())) {
          _this2.set('queryObject.rawQuery', response.query);
          _this2.set('validQuestion', true);
        }
      }, function (error, status) {
        if (!(withSelected && _this2.get('aceEditor') && _this2.get('aceEditor').getSelectedText())) {
          _this2.set('validQuestion', false);
          _this2.set('queryObject.rawQuery', error.query);
        }
      });
      //     this.set('loading', false);
      //     if (question.get('query_type') == 'api_client') {
    ...
    actions: {
      ...
      saveQuestion: function saveQuestion() {
        ...
        if (this.get('newQuestion')) {
          ...
          (function () {
            var question = _this3.get('question');
            ...
            question.save().then(function (response) {
              ...
              document.getElementById(_this3.get('vueIframeID')).contentWindow.postMessage({
                message: 'save_visualizations',
                question_id: response.id
              }, '*');

              _this3.set('retryingTransition', true);
              _this3.transitionToRoute('questions.show', response.id);
      ...
      downloadData: function downloadData() {
        ...
        this.get('ajax').apiCall({
          ...
          _this4.get('toast').success('Your CSV is getting uploaded to cloud. You\'ll get an email with download link shortly', 'YaY!', {
            closeButton: true,
            timeout: 1500,
            progressBar: false
          });
        }, function (error, status) {
          _this4.get('toast').success('Looks like CSV download process is not working as expected. Please try again. If problem persists, talk to your Admin', 'Sorry Mate!', {
            closeButton: true,
            timeout: 1500,
            progressBar: false
          });
...
define("frontend/pods/settings/databases/new/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "QRyfRtn8", "block": "{\"symbols\":[\"dbType\"],\"statements\":[[6,\"div\"],[9,\"class\",\"pl-3 pt-0\"],[7],[0,\"\\n    \"],[6,\"form\"],[9,\"class\",\"card\"],[7],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"card-body\"],[7],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n                \"],[6,\"label\"],[9,\"class\",\"form-label\"],[7],[0,\"Database Type\"],[8],[0,\"\\n                \"],[6,\"select\"],[9,\"class\",\"form-control\"],[10,\"onchange\",[25,\"action\",[[19,0,[]],\"selectDbType\"],[[\"value\"],[\"target.value\"]]],null],[7],[0,\"\\n\"],[4,\"each\",[[20,[\"dbTypes\"]]],null,{\"statements\":[[0,\"                        \"],[6,\"option\"],[10,\"value\",[19,1,[]],null],[10,\"selected\",[25,\"eq\",[[20,[\"db\",\"db_type\"]],[19,1,[]]],null],null],[7],[1,[25,\"capitalize\",[[19,1,[]]],null],false],[8],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"                \"],[8],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n                \"],[6,\"label\"],[9,\"class\",\"form-label\"],[7],[0,\"Name\"],[8],[0,\" \"],[1,[25,\"input\",null,[[\"type\",\"name\",\"class\",\"placeholder\",\"value\"],[\"text\",\"first-name\",\"form-control\",\"What do you call it?\",[20,[\"db\",\"name\"]]]]],false],[0,\"\\n                \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n                \"],[6,\"label\"],[9,\"class\",\"form-label\"],[7],[0,\"Host Url\"],[8],[0,\" \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"name\",\"placeholder\",\"value\"],[\"form-control\",\"text\",\"first-name\",\"Host endpoint\",[20,[\"db\",\"config\",\"host_url\"]]]]],false],[0,\"\\n                \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n                \"],[6,\"label\"],[9,\"class\",\"form-label\"],[7],[0,\"Host Port\"],[8],[0,\" \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"name\",\"placeholder\",\"value\"],[\"form-control\",\"number\",\"first-name\",\"Host Port\",[20,[\"db\",\"config\",\"host_port\"]]]]],false],[0,\"\\n                \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n                \"],[6,\"label\"],[9,\"class\",\"form-label\"],[7],[0,\"Database Name\"],[8],[0,\" \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"name\",\"placeholder\",\"value\"],[\"form-control\",\"text\",\"first-name\",\"Database Name\",[20,[\"db\",\"config\",\"db_name\"]]]]],false],[0,\"\\n                \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n                \"],[6,\"label\"],[9,\"class\",\"form-label\"],[7],[0,\"Database Username\"],[8],[0,\" \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"name\",\"placeholder\",\"value\"],[\"form-control\",\"text\",\"first-name\",\"Username\",[20,[\"db\",\"config\",\"username\"]]]]],false],[0,\"\\n                \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n                \"],[6,\"label\"],[9,\"class\",\"form-label\"],[7],[0,\"Database Password\"],[8],[0,\" \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"name\",\"placeholder\",\"value\"],[\"form-control\",\"password\",\"first-name\",\"Password\",[20,[\"db\",\"config\",\"password\"]]]]],false],[0,\"\\n                \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n                \"],[6,\"label\"],[9,\"class\",\"form-label\"],[7],[0,\"Connection Pool Size\"],[8],[0,\" \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"name\",\"placeholder\",\"value\"],[\"form-control\",\"number\",\"first-name\",\"10\",[20,[\"db\",\"config\",\"pool_size\"]]]]],false],[0,\"\\n                \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n                \"],[6,\"label\"],[9,\"class\",\"form-label\"],[7],[0,\"Connection Checkout Timeout in Seconds\"],[8],[0,\" \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"name\",\"placeholder\",\"value\"],[\"form-control\",\"number\",\"first-name\",\"45\",[20,[\"db\",\"config\",\"checkout_timeout\"]]]]],false],[0,\"\\n                \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n                \"],[6,\"label\"],[9,\"class\",\"form-label\"],[7],[0,\"Query Timeout in Seconds\"],[8],[0,\" \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"name\",\"placeholder\",\"value\"],[\"form-control\",\"password\",\"first-name\",\"Password\",[20,[\"db\",\"config\",\"query_timeout\"]]]]],false],[0,\"\\n                \"],[8],[0,\"\\n        \"],[8],[0,\"\\n        \"],[6,\"div\"],[9,\"class\",\"card-footer text-right\"],[7],[0,\"\\n            \"],[6,\"button\"],[9,\"class\",\"btn btn-primary\"],[9,\"type\",\"submit\"],[3,\"action\",[[19,0,[]],\"saveDatabase\"]],[7],[0,\"SAVE\"],[8],[0,\"\\n        \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/settings/databases/new/template.hbs" } });
});
...
define('frontend/pods/settings/reports/controller', ['exports'], function (exports) {
    exports['default'] = Ember.Controller.extend({
        ...
        actions: {
            ...
            setUseSignedS3UrlInEmails: function setUseSignedS3UrlInEmails() {
                var currentValue = this.get('use_signed_s3_url_in_emails.value');
                if (currentValue == 'false') {
...
define('frontend/pods/settings/version/controller', ['exports', 'ember', 'frontend/config/environment'], function (exports, _ember, _frontendConfigEnvironment) {
    exports['default'] = _ember['default'].Controller.extend({
        pageTitle: "Version",
        version: _frontendConfigEnvironment['default'].VERSION
    });
});
define('frontend/pods/settings/version/route', ['exports', 'ember'], function (exports, _ember) {
    exports['default'] = _ember['default'].Route.extend({
        setupController: function setupController(controller, model) {
            this._super.apply(this, arguments);
...
define("frontend/pods/settings/version/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "MSZzuPH4", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[9,\"class\",\"card ml-3\"],[7],[0,\"\\n\"],[6,\"div\"],[9,\"class\",\"card-footer text-center\"],[7],[0,\"\\n\"],[6,\"div\"],[9,\"class\",\"h1 mb-0\"],[7],[0,\"\\n\"],[1,[18,\"version\"],false],[0,\"\\n\"],[8],[0,\"\\n\"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "frontend/pods/settings/version/template.hbs" } });
});
...
if (!runningTests) {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+c0d529bd"});
}
